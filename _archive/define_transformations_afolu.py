...
class TransformationsAFOLU:
    ...
    def _initialize_attributes(
        ...
        * self.time_periods (support_classes.TimePeriods object)
        ...
        baseline_with_plur = (
            False if not isinstance(baseline_with_plur, bool) else baseline_with_plur
        )
    ...
    def _initialize_transformations(
        ...
        self.af_all_with_partial_reallocation = trl.Transformer(
            "AF:ALL_PLUR",
            [
                # self.transformation_agrc_decrease_exports,
                self.transformation_agrc_expand_conservation_agriculture,
        ...
        self.af_all_with_deforestation_and_partial_reallocation = trl.Transformer(
        ...
        """
        self.af_all_no_lvst_export_reduction_with_partial_reallocation = trl.Transformer(
        ...
        self.agrc_all_with_partial_reallocation = trl.Transformer(
            "AGRC:ALL_PLUR",
            [
                # self.transformation_agrc_decrease_exports,
                # self.transformation_agrc_improve_crop_residue_management,
        ...
        self.lndu_expand_silvopasture_with_partial_reallocation = trl.Transformer(
        ...
        self.lsmm_bundle_manure_management = trl.Transformer(
        ...
        self.lvst_all_with_partial_reallocation = trl.Transformer(
            "LVST:ALL_PLUR",
            [
                self.transformation_lvst_decrease_exports,
                self.transformation_lvst_increase_productivity,
        ...
        self.lvst_increase_productivity_with_partial_reallocation = trl.Transformer(
    ...
    def transformation_af_baseline(
        self,
        df_input: pd.DataFrame,
    ...
    def transformation_agrc_decrease_exports(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_agrc_expand_conservation_agriculture(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
        ...
        # 2. reduce burning and removals + increase improved pastures
        df_out = tbg.transformation_general(
            df_out,
            self.model_attributes,
            {
    ...
    def transformation_agrc_decrease_climate_productivity_climate_india(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lndu_increase_reforestation(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
        ...
        df_out = tba.transformation_frst_increase_reforestation(
            ...
            self.vec_implementation_ramp,
            self.model_attributes,
            cats_inflow_restriction=[
                "croplands",
                "other",
            ],  # SET FOR INDIA--NEED A BETTER WAY TO DETERMINE
            field_region=self.key_region,
            model_afolu=self.model_afolu,
            strategy_id=strat,
        )
    ...
    def transformation_lndu_stop_deforestation(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lndu_expand_silvopasture(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lndu_expand_sustainable_grazing(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lndu_integrated_transitions(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lndu_reallocate_land(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        baseline_with_plur: Union[bool, None] = None,
    ...
    def transformation_lsmm_improve_manure_management_cattle_pigs(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lsmm_improve_manure_management_other(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lsmm_improve_manure_management_poultry(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lsmm_increase_biogas_capture(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_lvst_decrease_exports(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_soil_reduce_excess_lime(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
