...
class TransformationsIntegrated:
    ...
    def _initialize_ramp(
        ...
        * self.vec_implementation_ramp_renewable_cap
        ...
        dict_entc_renewable_target_cats_max_investment = dict(
            (x, {"vec": vec_implementation_ramp_renewable_cap, "type": "scalar"})
    ...
    def build_strategies_long(
        ...
        strategies = self.all_transformations if strategies is None else strategies
    ...
    def _log(self, msg: str, type_log: str = "log", **kwargs) -> None:
    ...
    def transformation_support_entc_clean_grid(
        ...
        df_strat_cur = self.transformation_entc_renewables_target(df_input, strat)
        ...
        df_out = adt.transformation_general(
            ...
            self.model_attributes,
            {
                self.model_enercons.modvar_trns_modeshare_freight: {
                    ...
                    "categories_target": {"rail_freight": 1.0},
