...
class TransformersCircularEconomy:
    ...
    def build_strategies_long(
        ...
        t0 = time.time()
        self._log(
            f"TransformersCircularEconomy.build_strategies_long() starting build of {n} strategies...",
            type_log="info",
        )
        ...
        self._log(
            f"TransformersCircularEconomy.build_strategies_long() build complete in {t_elapse} seconds.",
            type_log="info",
        )
    ...
    def transformation_ce_baseline(
        self,
        df_input: pd.DataFrame,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_trww_increase_biogas_capture(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ...
    def transformation_wali_improve_sanitation_industrial(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_wali_improve_sanitation_rural(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_wali_improve_sanitation_urban(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_waso_decrease_food_waste(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_waso_increase_biogas_capture(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
