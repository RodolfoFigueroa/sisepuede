...
class TransformersEnergy:
    ...
    def get_entc_cats_max_investment_ramp(
        ...
        cats_entc_max_investment_ramp = (
            ...
            if isinstance(cats_entc_max_investment_ramp, list)
            or isinstance(cats_entc_max_investment_ramp, np.ndarray)
            else [
                "pp_geothermal",
                "pp_nuclear",
            ]
    ...
    def get_entc_cats_renewable(
        ...
        cats_renewable = (
            list(cats_renewable)
            if isinstance(cats_renewable, list)
            or isinstance(cats_renewable, np.ndarray)
            else [
                "pp_geothermal",
                "pp_hydropower",
                "pp_ocean",
    ...
    def get_inen_parameters(
        ...
        default_cats_inen_high_heat = [
            x
            for x in attr_industry.key_values
            if x
            in [
                "cement",
                "chemicals",
    ...
    def get_ramp_characteristics(
        ...
        n_tp_ramp = (
            default_n_tp_ramp if not sf.isnumber(n_tp_ramp, integer=True) else n_tp_ramp
        )
    ...
    def _initialize_attributes(
        ...
        * self.time_periods (support_classes.TimePeriods object)
        ...
        field_region = (
            model_attributes.dim_region if (field_region is None) else field_region
        )
    ...
    def _initialize_models(
        ...
        """
        model_afolu = (
            mafl.AFOLU(self.model_attributes) if model_afolu is None else model_afolu
        )
    ...
    def _initialize_transformations(
        ...
        dict_transformations = dict(
            (x.id, x) for x in all_transformations if x.id in attr_strategy.key_values
        )
        all_transformations = sorted(list(dict_transformations.keys()))
        all_transformations_non_baseline = [
            x for x in all_transformations if not dict_transformations.get(x).baseline
        ]

        transformation_id_baseline = [
            x for x in all_transformations if x not in all_transformations_non_baseline
        ]
        transformation_id_baseline = (
            transformation_id_baseline[0]
            if (len(transformation_id_baseline) > 0)
            else None
        )
    ...
    def build_implementation_ramp_vector(
        ...
        vec_out = np.array(
            [max(0, min((x - tp_0) / n_tp_ramp, 1)) for x in range(n_tp)]
        )
    ...
    def build_strategies_long(
        ...
        df_out = (
            ...
            else (self.baseline_inputs if self.baseline_inputs is not None else None)
        )
    ...
    def transformation_en_baseline(
        self,
        df_input: pd.DataFrame,
        strat: Union[int, None] = None,
    ...
    def transformation_ccsq_increase_air_capture(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_entc_least_cost(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_entc_reduce_transmission_losses(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_entc_renewables_target(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_support_entc_change_msp_max(
        self,
        ...
        **kwargs,
        ...
        cats_to_cap = ["pp_hydropower"] if cats_to_cap is None else cats_to_cap
        cats_to_cap = [
        ...
        dict_cat_to_vector = dict((x, self.vec_msp_resolution_cap) for x in cats_to_cap)
    ...
    def transformation_support_entc_clean_grid(
        self,
        df_input: Union[pd.DataFrame, None] = None,
    ...
    def transformation_support_entc_green_hydrogen(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_fgtv_minimize_leaks(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_inen_fuel_switch_high_temp(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_inen_fuel_switch_low_and_high_temp(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
        ...
        # set up fractions
        frac_shift_hh_elec = (
            self.frac_inen_low_temp_elec + self.frac_inen_high_temp_elec_hydg
        )
    ...
    def transformation_inen_fuel_switch_low_temp_to_heat_pump(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_inen_maximize_efficiency_energy(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_inen_maximize_efficiency_production(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_scoe_fuel_switch_electrify(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_scoe_reduce_heat_energy_demand(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_scoe_increase_applicance_efficiency(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_electrify_road_light_duty(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_electrify_rail(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_fuel_switch_maritime(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_fuel_switch_road_medium_duty(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_increase_efficiency_electric(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_increase_efficiency_non_electric(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_increase_occupancy_light_duty(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_mode_shift_freight(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_mode_shift_public_private(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_trns_mode_shift_regional(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
