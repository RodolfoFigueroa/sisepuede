...
class TransformersIPPU:
    ...
    def _initialize_models(
        ...
        """
        model_ippu = (
            mi.IPPU(self.model_attributes) if model_ippu is None else model_ippu
        )
    ...
    def transformation_ip_baseline(
        self,
        df_input: pd.DataFrame,
        strat: Union[int, None] = None,
    ) -> pd.DataFrame:
    ...
    def transformation_ippu_reduce_cement_clinker(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
    ...
    def transformation_ippu_reduce_hfcs(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_ippu_reduce_n2o(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_ippu_reduce_other_fcs(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
    ...
    def transformation_ippu_reduce_pfcs(
        self,
        df_input: Union[pd.DataFrame, None] = None,
        strat: Union[int, None] = None,
        vec_implementation_ramp: Union[np.ndarray, None] = None,
