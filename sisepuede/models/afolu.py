...
class AFOLU:
    ...
    def __init__(
        ...
        npp_integration_windows: Union[
            list, tuple, np.ndarray
        ] = _NPP_INTEGRATION_WINDOWS,
        **kwargs,
    ) -> None:
        self.logger = logger
    ...
    def _assign_cats_lndu(
        ...
        self.cats_lndu_stable_under_reallocation = (
            self.model_attributes.filter_keys_by_attribute(
                self.model_attributes.subsec_name_lndu,
                {
    ...
    def check_df_fields(
        ...
        check_fields = (
            self.required_variables if (check_fields is None) else check_fields
        )
        ...
        if not set(check_fields).issubset(df_afolu_trajectories.columns):
            ...
            raise KeyError(
                f"AFOLU projection cannot proceed: The fields {set_missing} are missing."
            )
    ...
    def _initialize_integrated_variables(
        self,
    ) -> None:
        ...
        * self.integration_variables
        ...
        for k in dict_vars_required_for_integration:
    ...
    def _initialize_models(
        ...
        """
        model_attributes = (
            self.model_attributes if (model_attributes is None) else model_attributes
        )
    ...
    def _initialize_npp_properties(
        self,
        npp_curve: Union[str, npp.NPPCurve, None] = None,
        npp_include_primary_forest: bool = False,
        npp_integration_windows: Union[
        ...
        * NPP Curve fitting for dynamic forest sequestration
        ...
        npp_curve = npp_curve if npp_curve in curves_npp.curves else None
        ...
        if error_q:
            ...
            raise RuntimeError(
                f"Unable to initialize npp_curve {npp_curve}: invalid integration window of type {tp} specified. Must be array-like."
            )
    ...
    def _initialize_subsector_vars_agrc(
        self,
    ) -> None:
        ...
        * self.modvar_list_agrc_****
        ...
        self.modvar_agrc_adjusted_equivalent_exports = (
            "Adjusted Agriculture Equivalent Exports"
        )
        self.modvar_agrc_adjusted_equivalent_imports = (
            "Adjusted Agriculture Equivalent Imports"
        )
        ...
        self.modvar_agrc_changes_to_net_imports_lost = (
            "Changes to Agriculture Net Imports Lost"
        )
        ...
        self.modvar_agrc_ef_ch4 = (
            ":math:\\text{CH}_4 Crop Anaerobic Decomposition Emission Factor"
        )
        self.modvar_agrc_ef_ch4_burning = (
            ":math:\\text{CH}_4 Crop Biomass Burning Emission Factor"
        )
        self.modvar_agrc_ef_co2_biomass = (
            ":math:\\text{CO}_2 Crop Biomass Emission Factor"
        )
        self.modvar_agrc_ef_n2o_burning = (
            ":math:\\text{N}_2\\text{O} Crop Biomass Burning Emission Factor"
        )
        self.modvar_agrc_ef_n2o_fertilizer = (
            ":math:\\text{N}_2\\text{O} Crop Fertilizer and Lime Emission Factor"
        )
        self.modvar_agrc_elas_crop_demand_income = "Crop Demand Income Elasticity"
        self.modvar_agrc_emissions_ch4_biomass_burning = (
            ":math:\\text{CH}_4 Emissions from Biomass Burning"
        )
        ...
        self.modvar_agrc_emissions_co2_soil_carbon_organic = (
            ":math:\\text{CO}_2 Emissions from Soil Carbon in Organic Soils"
        )
        self.modvar_agrc_emissions_n2o_biomass_burning = (
            ":math:\\text{N}_2\\text{O} Emissions from Biomass Burning"
        )
        ...
        self.modvar_agrc_frac_demand_imported = (
            "Fraction of Agriculture Demand Imported"
        )
        ...
        self.modvar_agrc_frac_production_lost = (
            "Fraction of Food Produced Lost Before Consumption"
        )
        self.modvar_agrc_frac_production_loss_to_msw = (
            "Fraction of Food Loss Sent to Municipal Solid Waste"
        )
        ...
        self.modvar_agrc_ratio_above_ground_residue_to_harvested_yield = (
            "Ratio of Above Ground Residue to Harvested Yield"
        )
        ...
        self.modvar_agrc_regression_m_above_ground_residue = (
            "Above Ground Residue Dry Matter Slope"
        )
        self.modvar_agrc_regression_b_above_ground_residue = (
            "Above Ground Residue Dry Matter Intercept"
        )
        self.modvar_agrc_total_food_lost_in_ag = (
            "Total Food Produced Lost Before Consumption"
        )
        self.modvar_agrc_total_food_lost_in_ag_to_msw = (
            "Total Food Loss Sent to Municipal Solid Waste"
        )
    ...
    def _initialize_subsector_vars_frst(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_list_frst_****
        ...
        self.modvar_frst_average_fraction_burned_annually = (
            "Average Fraction of Forest Burned Annually"
        )
        self.modvar_frst_biomass_consumed_fire_temperate = (
            "Fire Biomass Consumption for Temperate Forests"
        )
        self.modvar_frst_biomass_consumed_fire_tropical = (
            "Fire Biomass Consumption for Tropical Forests"
        )
        self.modvar_frst_ef_c_per_hwp = (
            "C Carbon Harvested Wood Products Emission Factor"
        )
        ...
        self.modvar_frst_sq_co2_young_secondary = (
            "Young Secondary Forest Sequestration Emission Factor"
        )
    ...
    def _initialize_subsector_vars_lndu(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_list_lndu_****
        ...
        self.modvar_lndu_emissions_co2_sequestration = (
            ":math:\\text{CO}_2 Emissions from Land Use Biomass Sequestration"  # NEW
        )
    ...
    def _initialize_subsector_vars_lsmm(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_dict_lsmm_****
        ...
        self.modvar_lsmm_ef_direct_n2o = (
            ":math:\\text{N}_2\\text{O} Manure Management Emission Factor"
        )
        self.modvar_lsmm_emissions_ch4 = (
            ":math:\\text{CH}_4 Emissions from Manure Management"
        )
        ...
        self.modvar_lsmm_frac_loss_volatilisation = (
            "Fraction of Nitrogen Lost to Volatilisation"
        )
        self.modvar_lsmm_frac_n_available_used = (
            "Fraction of Nitrogen Used in Fertilizer"
        )
        ...
        self.modvar_lsmm_n_to_fertilizer_agg_dung = (
            "Total Nitrogen Available for Fertilizer from Dung"
        )
        self.modvar_lsmm_n_to_fertilizer_agg_urine = (
            "Total Nitrogen Available for Fertilizer from Urine"
        )
        self.modvar_lsmm_n_to_other_use = (
            "Total Nitrogen Available for Construction/Feed/Other"
        )
        self.modvar_lsmm_ratio_n2_to_n2o = (
            "Ratio of :math:\\text{N}_2 to :math:\\text{N}_2\\text{O}"
        )
        self.modvar_lsmm_recovered_biogas = (
            "LSMM Biogas Recovered from Anaerobic Digesters"
        )
        self.modvar_lsmm_rf_biogas = (
            "Biogas Recovery Factor at LSMM Anaerobic Digesters"
        )
    ...
    def _initialize_subsector_vars_lvst(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_dict_lvst_****
        ...
        self.modvar_lvst_adjusted_equivalent_exports = (
            "Adjusted Livestock Equivalent Exports"
        )
        self.modvar_lvst_adjusted_equivalent_imports = (
            "Adjusted Livestock Equivalent Imports"
        )
        ...
        self.modvar_lvst_changes_to_net_imports_lost = (
            "Changes to Livestock Net Imports Lost"
        )
        ...
        self.modvar_lvst_ef_ch4_ef = (
            ":math:\\text{CH}_4 Enteric Fermentation Emission Factor"
        )
        ...
        self.modvar_lvst_genfactor_volatile_solids = (
            "Daily Volatile Solid Generation Factor"
        )
        self.modvar_lvst_b0_manure_ch4 = (
            "Maximum Manure :math:\\text{CH}_4 Generation Capacity"
        )
        ...
        modvar_list_lvst_mm_fractions = [
            x for x in modvar_list_lvst_mm_fractions if (x is not None)
        ]
    ...
    def _initialize_subsector_vars_soil(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_dict_soil_****
        ...
        self.modvar_soil_ef1_n_managed_soils_rice = (
            ":math:\\text{EF}_{1FR} - \\text{N}_2\\text{O} Rice Fields"
        )
        ...
        self.modvar_soil_ef1_n_managed_soils_syn_fert = (
            ":math:\\text{EF}_1 - \\text{N}_2\\text{O} Synthetic Fertilizer"
        )
        ...
        self.modvar_soil_ef4_n_volatilisation = (
            "EF4 N Volatilisation and Re-Deposition Emission Factor"
        )
        ...
        self.modvar_soil_ef_c_organic_soils = (
            "C Annual Cultivated Organic Soils Emission Factor"
        )
        ...
        self.modvar_soil_qtyinit_liming_dolomite = (
            "Initial Liming Dolomite Applied to Soils"
        )
        self.modvar_soil_qtyinit_liming_limestone = (
            "Initial Liming Limestone Applied to Soils"
        )
        self.modvar_soil_ratio_c_to_n_soil_organic_matter = (
            "C to N Ratio of Soil Organic Matter"
        )
    ...
    def adjust_transition_matrix(
        ...
        * NOTE: Applying large scalars will lead to dominance, and eventually
        ...
        for ind in [x for x in dict_tuples_scale if len(x) == 1]:
        ...
        for ind in [x for x in dict_tuples_scale if len(x) == 2]:
            i, j = ind
        ...
        mat_out = (
            (mat_mask_response_nodes * mat_mask * mat).transpose() * mask_scalar
        ).transpose()
    ...
    def back_project_hwp_c_k(
        ...
        n_tps_mean = min(
            n_tps_mean, len(vec_frst_c_paper) - 1
        )  # -1 because we apply the mean to rates
        ...
        # paper products
        r_paper = np.mean(
            vec_frst_c_paper[1 : (1 + n_tps_mean)] / vec_frst_c_paper[0:n_tps_mean]
        )
        ...
        # wood products
        r_wood = np.mean(
            vec_frst_c_wood[1 : (1 + n_tps_mean)] / vec_frst_c_wood[0:n_tps_mean]
        )
    ...
    def calculate_ipcc_soc_deltas(
        ...
        if approach == 1:
            vec_soc_delta = np.concatenate(
                [np.ones(self.time_dependence_stock_change) * vec_soc[0], vec_soc]
            )
            vec_soc_delta = (
                vec_soc_delta[self.time_dependence_stock_change :]
                - vec_soc_delta[
                    0 : (len(vec_soc_delta) - self.time_dependence_stock_change)
                ]
            ) / self.time_dependence_stock_change
        elif approach == 2:
    ...
    def calculate_soc_stock_change_with_time_dependence(
        self,
        ...
        vec_proportional_sequestration = np.array(
            [sequestration_curve(x) for x in range(D)]
        )
        ...
        for i in range(n):
            ...
            v_cur_sequestration = vec_proportional_sequestration * (
                arrs_sequestration[i].sum()
            )
    ...
    def check_cropland_fractions(
        ...
        if frac_type not in ["initial", "calculated"]:
            raise ValueError(
                f"Error in frac_type '{frac_type}': valid values are 'initial' and 'calculated'."
            )
    ...
    def check_markov_shapes(
        ...
        if arrs.shape[1:3] != (attr_lndu.n_key_values, attr_lndu.n_key_values):
            msg = f"""
    ...
    def format_lndu_conversion_emissions_and_scale_secondary_forest(
        self,
        ...
        df_lndu_emissions_conv_matrices = (
            self.format_transition_matrix_as_input_dataframe(
                arrs_out,
    ...
    def format_transition_matrix_as_input_dataframe(
        self,
        mat: np.ndarray,
        ...
        attr_time_period = self.model_attributes.get_dimensional_attribute_table(
            field_time_period
        )
        ...
        field_key_vals = [
            x[1] for x in itertools.product(np.ones(mat_shape[0]), key_vals)
        ]
        field_time_periods = np.concatenate(
            np.outer(
                vec_time_periods,
                np.ones(mat.shape[1]),
            ),
        ...
        field_variables = [
            x[1] for x in itertools.product(np.ones(mat_shape[0]), field_variables)
        ]
    ...
    def get_lndu_areas_to_from_remaining(
        self,
    ...
    def get_frst_area_from_df(
        ...
        fields_lndu_forest_ordered = [
            self.dict_cats_frst_to_cats_lndu.get(x) for x in attr_frst.key_values
        ]
    ...
    def get_frst_sequestration_and_land_use_conversion_emission(
        self,
        df_afolu_trajectories: pd.DataFrame,
        ...
        **kwargs,
        ...
        df_lndu_emissions_conversion = (
            self.format_lndu_conversion_emissions_and_scale_secondary_forest(
    ...
    def get_frst_sequestration_from_npp(
        self,
        df_afolu_trajectories: pd.DataFrame,
        arrs_lndu_conversion: np.ndarray,
        ...
        **kwargs,
        ...
        vec_area_secondary_remaining_from_original = (
            np.ones(n_tp) * arr_lndu_areas[0, self.ind_lndu_fsts]
        )
        ...
        for i, arr in enumerate(arrs_lndu_conversion):
            tp = tps[i]
            tup = (tp, npp_curve)
            area_to, area_from, area_remaining = self.get_lndu_areas_to_from_remaining(
                arr, self.ind_lndu_fsts
            )
            ...
            if i < n_tp - 1:
                arr_cumulative_mass_to_collapse[(i + 1) :, i] = (
                    arr_cmf[0 : (n_tp - i - 1), 1] * area_to
                )
        ...
        vec_area_converted_from_new = (
            vec_area_converted_from_total - vec_area_converted_from_original
        )
        ...
        vec_sequestration_secondary += (
            vec_area_secondary_remaining_from_original * sf_frst_secondary_init
        )
        arr_sequestration[:, self.ind_frst_scnd] = vec_sequestration_secondary

        # get the scalar for land use conversion to apply
        vec_frac_area_converted_from_new = (
            vec_area_converted_from_new / vec_area_converted_from_total
        )
        vec_conversion_scalar = (
            arr_cumulative_mass_to_collapse.sum(axis=1) / vec_area_new_total
        )  # weighted average of
        vec_conversion_scalar *= vec_frac_area_converted_from_new
        vec_conversion_scalar += 1 - vec_frac_area_converted_from_new
        vec_conversion_scalar = np.nan_to_num(
            vec_conversion_scalar, nan=1.0, posinf=1.0
        )
        ...
        vec_frst_prevalence_scalar = np.nan_to_num(
            vec_frst_prevalence_scalar, nan=1.0, posinf=1.0
        )

        vec_frst_ef_ch4_secondary = (
            arr_frst_ef_methane[:, self.ind_frst_scnd] * vec_frst_prevalence_scalar
        )
        arr_frst_emission_methane[:, self.ind_frst_scnd] = (
            arr_frst_areas[:, self.ind_frst_scnd] * vec_frst_ef_ch4_secondary
        )
    ...
    def _get_frst_sequestration_from_npp_build_cmf_df(
        self,
        df_afolu_trajectories: pd.DataFrame,
        cmf: np.ndarray,
        field_cmf: str,
    ...
    def get_frst_sequestration_factors(
        self,
        df_afolu_trajectories: pd.DataFrame,
    ...
    def get_frst_sequestration_static(
        self,
        df_afolu_trajectories: pd.DataFrame,
    ...
    def get_lndu_scalar_max_out_states(
        self,
        ...
        lmo_approach = (
            self.model_attributes.configuration.get(
        ...
        out = (
            np.array(
                [int(x in cats_max_out) for x in attribute_land_use.key_values]
            ).astype(int)
            if proceed_q
    ...
    def get_lndu_soil_soc_factors(
        ...
        arr_lndu_factor_soil_management_inf = (
        ...
        arr_lndu_factor_soil_management_sup = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_lndu_factor_soil_management_supremum,
                all_cats_missing_val=1.0,
        ...
        arr_lndu_factor_soil_inputs_no_manure_sup = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_lndu_factor_soil_inputs_supremum_no_manure,
                all_cats_missing_val=1.0,
        ...
        arr_agrc_crop_area_improved = (
            arr_agrc_crop_area * arr_agrc_frac_improved_by_crop
        )
        vec_lndu_frac_cropland_improved = (arr_agrc_crop_area_improved).sum(axis=1)
        vec_lndu_frac_cropland_improved /= arr_lndu_prevalence[
            :, self.ind_lndu_crop
        ]  # should be a denominator of 1, but just to be safe

        # get the cropland management factor
        vec_lndu_fmg_cropland = (
            vec_lndu_frac_cropland_improved
            * arr_lndu_factor_soil_management_sup[:, self.ind_lndu_crop]
        )
        vec_lndu_fmg_cropland += (
            1 - vec_lndu_frac_cropland_improved
        ) * arr_lndu_factor_soil_management_inf[:, self.ind_lndu_crop]

        # get fraction removed/burned
        vec_agrc_frac_residue_burned = dict_fracs_residues_removed_burned.get(
            self.modvar_agrc_frac_residues_burned
        ).flatten()
        vec_agrc_frac_residue_removed = dict_fracs_residues_removed_burned.get(
            self.modvar_agrc_frac_residues_removed
        ).flatten()
        vec_agrc_frac_residue_inputs = (
            1 - vec_agrc_frac_residue_burned - vec_agrc_frac_residue_removed
        )

        # calculate the input componen
        vec_agrc_inputs_component = sf.vec_bounds(
            arr_lndu_factor_soil_inputs_no_manure_sup[:, self.ind_lndu_crop] - 1, (0, 1)
        )
        ...
        # get pasture
        vec_lndu_fmg_pasture = (
            1 - vec_lndu_frac_pastures_improved
        ) * arr_lndu_factor_soil_management_inf[:, self.ind_lndu_pstr]
        vec_lndu_fmg_pasture += (
            vec_lndu_frac_pastures_improved
            * arr_lndu_factor_soil_management_sup[:, self.ind_lndu_pstr]
        )
        vec_lndu_area_pasture_improved = (
            arr_lndu_prevalence[:, self.ind_lndu_pstr] * vec_lndu_frac_pastures_improved
        )

        # update output array
        arr_lndu_factor_soil_management = np.ones(
            arr_lndu_factor_soil_management_sup.shape
        )
        arr_lndu_factor_soil_management[:, self.ind_lndu_crop] = vec_lndu_fmg_cropland
        arr_lndu_factor_soil_management[:, self.ind_lndu_grss] = (
            default_fmg_grassland_not_pasture
        )
        ...
        arr_lndu_area_improved[:, self.ind_lndu_crop] = arr_agrc_crop_area_improved.sum(
            axis=1
        )
    ...
    def get_lvst_area_required(
        ...
        ##  AREA OF LAND NEEDED
        #
        area_total_land_needed = (
            vec_lvst_annual_dry_matter_consumption * vec_lvst_production_needed
        ).sum()
        area_total_land_needed /= factor_lndu_dry_matter_production

        return area_total_land_needed

    def get_lvst_dict_lsmm_categories_to_lvst_fraction_variables(
        self,
    ) -> Dict:
    ...
    def get_lvst_pasture_max_yield_and_carrying_capacity(
        self,
        df_afolu_trajectories: pd.DataFrame,
        ...
        total_yield_lndu_pasture_sup = (
            area_lndu_pasture_init * vec_lndu_yf_pasture_sup[0]
        )
        ...
        lvst_total_dry_matter_required = (
            vec_lvst_production_init
            * arr_lvst_annual_dry_matter_consumption_per_capita[0]
        )
        ...
        factor_lndu_init_avg_consumption_pstr = (
            lvst_total_dry_matter_required / area_lndu_pasture_init
        )
        ...
        vec_lvst_carry_capacity_scale = sf.vec_bounds(
            ...
            [
                (0.0, x)
                for x in vec_lndu_yf_pasture_sup_adj
                / factor_lndu_init_avg_consumption_pstr
            ],
        )
    ...
    def get_lvst_production_supported(
        self,
        ...
        vec_lndu_total_yield_pstr_unadj = (
            factor_lndu_init_avg_consumption_pstr * scalar_lvst_cc
        )
        vec_lndu_total_yield_pstr_unadj *= area_pstr_proj

        ##  NUMBER OF LIVESTOCK THAT CAN BE SUPPORTED
        #
        vec_lndu_total_yield_needed = (
            vec_lvst_annual_dry_matter_consumption * vec_lvst_annual_production_unadj
        ).sum()
        vec_lvst_prod_supportable = (
            vec_lndu_total_yield_pstr_unadj / vec_lndu_total_yield_needed
        )
    ...
    def get_markov_matrices(
        ...
        fields_pij = self.model_attributes.dict_model_variables_to_variable_fields.get(
            self.modvar_lndu_prob_transition
        )
        fields_efc = self.model_attributes.dict_model_variables_to_variable_fields.get(
            self.modvar_lndu_ef_co2_conv
        )
        if (fields_pij is None) | ((fields_efc is None) & get_emission_factors):
            return None

        fields_check = fields_pij + fields_efc if get_emission_factors else fields_pij
    ...
    def get_matrix_column_scalar(
        ...
        if not sf.islistlike(mask_max_out_states):
            ...
            mask_max_out_states = sf.vec_bounds(
                np.round(mask_max_out_states).astype(int), (0, 1)
            )
        ...
        area_incoming_from_max_out_states_at_current = np.sum(
            mask_max_out_states * vec_x * mat_column
        )
        ...
        if np.sum(mask_max_out_states) > 0:
            ...
            max_scale = (
                area_incoming_from_max_out_states_at_full
                / area_incoming_from_max_out_states_at_current
        ...
        n = len(vec_x)
        n_iter = (
            max_iter  # *2 if (sum(mask_max_out_states) < len(mat_column)) else max_iter
        )
        ...
        while (
            (np.abs(area / area_target - 1) > eps)
            and (len(w_unscalable) < n)
            and (i < n_iter)
        ):
    ...
    def get_mineral_soc_change_matrices(
        self,
        ...
        arrs_delta_soc_source = np.zeros(
            (n_tp, attr_lndu.n_key_values, attr_lndu.n_key_values)
        )
        ...
        for modvar in dict_soil_fracs_to_use_agrc:
            # soil category
            cat_soil = clean_schema(
                self.model_attributes.get_variable_attribute(modvar, attr_soil.key)
            )
            ind_soil = attr_soil.get_key_value_index(cat_soil)
            vec_agrc_avg_soc_cur = np.sum(
                arr_agrc_crop_area * dict_soil_fracs_to_use_agrc[modvar], axis=1
            )
            vec_soil_ef1_soc_est += (
                vec_agrc_avg_soc_cur
                * arr_soil_ef1_organic[:, ind_soil]
                / vec_soil_area_crop_pasture
            )
            vec_agrc_avg_soc_cur = np.nan_to_num(
                vec_agrc_avg_soc_cur / vec_agrc_area, nan=0.0, posinf=0.0
            )
            vec_agrc_avg_soc_cur *= (
            ...
            vec_agrc_avg_soc += (
                vec_agrc_avg_soc_cur
                * arr_lndu_frac_mineral_soils[:, self.ind_lndu_crop]
            )
        ...
        dict_lndu_forest_to_frst_forest = (
        ...
        inds_frst = np.array(
            [
                (
                    ...
                    attr_frst.get_key_value_index(dict_lndu_forest_to_frst_forest[x]),
                )
                for x in dict_lndu_forest_to_frst_forest.keys()
            ]
        )
        inds_lndu = inds_frst[:, 0]
        inds_frst = inds_frst[:, 1]

        for modvar in dict_soil_fracs_to_use_frst:
            # soil category
            cat_soil = clean_schema(
                self.model_attributes.get_variable_attribute(modvar, attr_soil.key)
            )
            ...
            arr_frst_avg_soc_cur = (
                arr_lndu_area[:, inds_lndu]
                * dict_soil_fracs_to_use_frst[modvar][:, inds_frst]
            )
            arr_frst_avg_soc_cur = np.nan_to_num(
            ...
            arr_frst_avg_soc += (
                arr_frst_avg_soc_cur.transpose()
                * arr_lndu_frac_mineral_soils[:, inds_lndu]
            )
        ...
        cats_lndu = list(
            set(
                sum(
                    [
                        self.model_attributes.get_variable_categories(x)
                        for x in dict_soil_fracs_to_use_lndu
                    ],
                    [],
                )
            )
        ...
        for modvar, arr_frac in dict_soil_fracs_to_use_lndu.items():
            ...
            arr_lndu_avg_soc_cur = np.nan_to_num(
            ...
            arr_lndu_avg_soc_cur *= arr_lndu_factor_soil_management[
                :, inds_lndu
            ].transpose()

            # add to weighted average
            arr_lndu_avg_soc += (
                arr_lndu_avg_soc_cur.transpose()
                * arr_lndu_frac_mineral_soils[:, inds_lndu]
            )
    ...
    def get_npp_biomass_sequestration_curves(
        self,
        ...
        **kwargs,
        ...
        vec_widths = (
            self.npp_integration_windows.copy() if vec_widths is None else vec_widths
        )
        ...
        for i, row in df_ordered_sequestration.iterrows():
            ...
            inputs = list(zip(vec_factors, vec_widths, strict=False))
    ...
    def get_npp_convergence_tolerance(
        self,
        ...
        **kwargs,
        ...
        logs = np.array(
            [
                np.log10(v)
                for k, v in series_factors.to_dict().items()
    ...
    def get_npp_frst_sequestration_factor_vectors(
        self,
        df_afolu_trajectories: pd.DataFrame,
        field_ord_1: str = "young",
        field_ord_2: str = "secondary",
    ...
    def get_transition_matrix_from_long_df(
        self,
        ...
        # indices
        vec_i = np.array(
            df_transition_out[field_i].apply(attr_lndu.get_key_value_index),
        )

        vec_j = np.array(
            df_transition_out[field_j].apply(attr_lndu.get_key_value_index),
        )
    ...
    def plot_npp_fit_curve(
        ...
        **kwargs,
        ...
        fig, ax = (
            subplots(figsize=(10, 8)) if not is_valid_figtuple(figtuple) else figtuple
        )
    ...
    def project_agrc_lvst_integrated_demands(
        self,
        df_afolu_trajectories: pd.DataFrame,
        ...
        vec_lvst_exports_modifier = sf.vec_bounds(
            vec_lvst_production_init - arr_lvst_exports_unadj[0], (-np.inf, 0)
        )
        arr_lvst_exports_unadj = sf.vec_bounds(
            arr_lvst_exports_unadj + vec_lvst_exports_modifier, (0, np.inf)
        )

        # get the demand
        vec_lvst_domestic_demand_init = sf.vec_bounds(
            vec_lvst_production_init - arr_lvst_exports_unadj[0], (0, np.inf)
        )
        ...
        vec_gnrl_frac_eating_red_meat_scalar = sf.vec_bounds(
            vec_gnrl_frac_eating_red_meat / vec_gnrl_frac_eating_red_meat[0], (0, 1)
        )
        ...
        arr_lvst_domestic_production_for_domestic_demand_unadj = (
            arr_lvst_domestic_demand_unadj - arr_lvst_imports_unadj
        )
        ...
        vec_lvst_feed_allocation_weights /= np.dot(
            vec_lvst_production_init, vec_lvst_base_graze_weights
        )
        ...
        vec_agrc_frac_cropland_area = self.check_cropland_fractions(
            df_afolu_trajectories, "initial"
        )[0]
        vec_agrc_cropland_area = (
            vec_modvar_lndu_initial_area[self.ind_lndu_crop]
        ...
        vec_agrc_demscale = (
            vec_gnrl_frac_eating_red_meat
            + vec_agrc_diet_exchange_scalar
            - vec_gnrl_frac_eating_red_meat * vec_agrc_diet_exchange_scalar
        )
        vec_agrc_demscale = np.nan_to_num(
            vec_agrc_demscale / vec_agrc_demscale[0], nan=1.0, posinf=1.0
        )
        ...
        arr_agrc_demscale = arr_agrc_demscale + np.outer(
            np.ones(len(vec_agrc_demscale)), 1 - vec_agrc_scale_demands_for_veg
        )
        ...
        vec_agrc_domestic_demand_init = sf.vec_bounds(
            vec_agrc_yield_init - arr_agrc_exports_unadj[0], (0, np.inf)
        )
        ...
        vec_agrc_domestic_demand_init_lvstfeed = (
            vec_agrc_domestic_demand_init * arr_agrc_frac_feed[0]
        )
        vec_agrc_domestic_demand_init_nonlvstfeed = (
            vec_agrc_domestic_demand_init - vec_agrc_domestic_demand_init_lvstfeed
        )
        vec_agrc_production_init_lvstfeed = vec_agrc_domestic_demand_init_lvstfeed * (
            1 - arr_agrc_frac_imported[0]
        )
        ...
        arr_agrc_imports_unadj = (
            arr_agrc_domestic_demand_nonfeed_unadj * arr_agrc_frac_imported
        )
        ...
        vec_agrc_frac_production_wasted_scalar = np.nan_to_num(
            (1 - vec_agrc_frac_production_wasted[0])
            / (1 - vec_agrc_frac_production_wasted),
            nan=0.0,
            posinf=0.0,
        )

        arr_agrc_production_nonfeed_unadj = (
            arr_agrc_production_nonfeed_unadj.transpose()
            * vec_agrc_frac_production_wasted_scalar
        ).transpose()
        arr_agrc_domestic_demand_nonfeed_unadj = (
            arr_agrc_production_nonfeed_unadj + arr_agrc_imports_unadj
        )

        # array gives the total yield of crop type i allocated to livestock type j at time 0
        arr_lndu_yield_i_reqd_lvst_j_init = np.outer(
            vec_agrc_production_init_lvstfeed, vec_lvst_feed_allocation_weights
        )
    ...
    def project_per_capita_demand(
        ...
        dem_scale_proj_pc = (
            gdp_per_capita_rates.transpose() * elast[0:-1].transpose()
        ).transpose()
        dem_scale_proj_pc = np.cumprod(1 + dem_scale_proj_pc, axis=0)
        dem_scale_proj_pc = np.concatenate(
            [np.ones((1, len(dem_scale_proj_pc[0]))), dem_scale_proj_pc]
        )

        # estimate demand for livestock (used in CBA) - start with livestock population per capita
        dem_pc_scalar_exog = (
            np.ones(pop.shape) if (dem_pc_scalar_exog is None) else dem_pc_scalar_exog
        )
        ...
        if dem_pc_scalar_exog.shape == pop.shape:
            ...
            raise ValueError(
                f"Invalid shape of dem_pc_scalar_exog: valid shapes are '{pop.shape}' and '{dem_scale_proj_pc.shape}'."
            )
    ...
    def project_integrated_land_use(
        self,
        ...
        arr_agrc_frac_cropland = np.array(
            [vec_agrc_frac_cropland_area for k in range(n_tp)]
        )
        ...
        arr_agrc_yield = np.array(
            [
                (
                    vec_initial_area[self.ind_lndu_crop]
                    * vec_agrc_frac_cropland_area
                    * arr_agrc_yield_factors[0]
                )
                for k in range(n_tp)
            ]
        )
        ...
        arrs_land_conv = np.zeros(
            (n_tp, attr_lndu.n_key_values, attr_lndu.n_key_values)
        )
        arrs_transitions_adj = np.zeros(arrs_transitions.shape)

        arrs_yields_per_livestock = np.array(
            [arr_lndu_yield_by_lvst for k in range(n_tp)]
        )
        ...
        while i < n_tp - 1:
            ...
            inds_lvst_where_pop_noncc = np.where(
                arr_lvst_annual_dry_matter_consumption_per_capita[i + 1] == 0
            )[0]
            ...
            vec_lvst_pop_adj = (
                vec_lvst_prod_supported_pre_realloc + vec_lvst_unmet_demand_lost
            )
            if len(inds_lvst_where_pop_noncc) > 0:
                ...
                np.put(
                    vec_lvst_pop_adj,
                    inds_lvst_where_pop_noncc,
                    arr_lvst_dem[i + 1, inds_lvst_where_pop_noncc],
                )

            vec_lvst_unmet_demand = vec_lvst_unmet_demand_to_impexp.copy()
            vec_lvst_reallocation_target = (
                vec_lvst_unmet_demand * vec_lndu_yrf[i + 1]
            )  # demand for livestock met by reallocating land
            ...
            vec_agrc_feed_dem_yield = sum(
                (arr_lndu_yield_by_lvst * vec_lvst_dem_gr_iterator).transpose()
            )
            vec_agrc_total_dem_yield = (
                arr_agrc_production_nonfeed_unadj[i + 1] + vec_agrc_feed_dem_yield
            )

            # calculate net surplus for yields
            vec_agrc_proj_yields = (
                vec_agrc_cropland_area_proj * arr_agrc_yield_factors[i + 1]
            )
            vec_agrc_unmet_demand_yields = (
                vec_agrc_total_dem_yield - vec_agrc_proj_yields
            )
            ...
            vec_agrc_unmet_demand_yields_lost = (
                vec_agrc_unmet_demand_yields - vec_agrc_unmet_demand_yields_to_impexp
            )

            # adjust yields for import/export scalar
            vec_agrc_proj_yields_adj = (
                vec_agrc_proj_yields + vec_agrc_unmet_demand_yields_lost
            )
            ...
            vec_agrc_total_dem_yield = (
                vec_agrc_proj_yields_adj + vec_agrc_unmet_demand_yields_to_impexp
            )
            ...
            vec_agrc_net_imports_increase = (
                vec_agrc_unmet_demand - vec_agrc_reallocation_target
            ) * vec_agrc_yield_factors_adj
            vec_agrc_cropareas_adj = (
                vec_agrc_cropland_area_proj + vec_agrc_reallocation_target
            )
            ...
            vec_lvst_net_imports_increase_adjustment = np.nan_to_num(
                (area_target_pstr - x_next[self.ind_lndu_pstr])
                / area_lndu_pstr_increase_0,
                nan=0.0,
                posinf=0.0,
                neginf=0.0,
            )
            ...
            vec_lvst_reallocation = (
                vec_lvst_reallocation_target - vec_lvst_net_imports_increase_adjustment
            )
            vec_lvst_net_import_increase = (
                vec_lvst_unmet_demand - vec_lvst_reallocation
            )  # demand for livestock met by increasing net imports (neg => net exports)
            vec_lvst_pop_adj += vec_lvst_reallocation
            vec_lvst_dem_gr_iterator = np.nan_to_num(
                vec_lvst_pop_adj / arr_lvst_dem[0], nan=1.0, posinf=1.0
            )
            ...
            vec_agrc_net_imports_increase_adjustment = np.nan_to_num(
                (area_target_crop - x_next[self.ind_lndu_crop])
                / vec_agrc_reallocation_target.sum(),
                nan=0.0,
                posinf=0.0,
                neginf=0.0,
            )
            ...
            vec_agrc_cropareas_adj = (
                vec_agrc_cropareas_adj / vec_agrc_cropareas_adj.sum()
            )
            vec_agrc_cropareas_adj *= x_next[self.ind_lndu_crop]
            vec_agrc_yield_adj = (
                vec_agrc_total_dem_yield - vec_agrc_net_imports_increase
            )

            ##  CALCULATE FINAL LAND CONVERSION AND EMISSIONS

            arr_land_conv = (arr_transition_adj.transpose() * x.transpose()).transpose()
            arr_emissions_conv_matrix = (
                arr_transition_adj * arrs_efs[i_ef]
            ).transpose() * x.transpose()  # sums across columns
            ...
            if i + 1 < n_tp:
                ...
                rng_agrc = list(
                    range(
                        (i + 1) * attr_agrc.n_key_values,
                        (i + 2) * attr_agrc.n_key_values,
                    )
                )
                np.put(
                    arr_agrc_change_to_net_imports_lost,
                ...
                np.put(
                    arr_agrc_frac_cropland,
                    rng_agrc,
                    vec_agrc_cropareas_adj / sum(vec_agrc_cropareas_adj),
                )
                np.put(
                    arr_agrc_net_import_increase,
                    rng_agrc,
                    np.round(vec_agrc_net_imports_increase),
                    2,
                )
                ...
                arr_lvst_net_import_increase[i + 1] = np.round(
                    vec_lvst_net_import_increase
                ).astype(int)

            # non-ag arrays
            rng_put = np.arange(
                (i) * attr_lndu.n_key_values, (i + 1) * attr_lndu.n_key_values
            )
        ...
        arr_emissions_conv_matrix = (
            trans_adj * arrs_efs[len(arrs_efs) - 1]
        ).transpose() * x.transpose()  # sums across columns
        arr_emissions_conv_matrix = arr_emissions_conv_matrix.transpose()
        vec_emissions_conv = arr_emissions_conv_matrix.sum(axis=1)
    ...
    def project_land_use(
        ...
        while i < n_tp:
            ...
            vec_emissions_conv = sum(
                (arrs_transitions[i_tr] * arrs_efs[i_ef]).transpose() * x.transpose()
            )
            arr_land_conv = (
                arrs_transitions[i_tr].transpose() * x.transpose()
            ).transpose()
            ...
            np.put(
                arrs_land_conv,
                np.arange(
                    i * attr_lndu.n_key_values**2, (i + 1) * attr_lndu.n_key_values**2
                ),
                arr_land_conv,
            )
        ...
        self._log(
            f"Land use projection complete in {t_elapse} seconds.", type_log="info"
        )

        return arr_emissions_conv, arr_land_use, arrs_land_conv

    def project_harvested_wood_products(
        self,
        df_afolu_trajectories: pd.DataFrame,
        vec_hh: np.ndarray,
        vec_gdp: np.ndarray,
        ...
        historical_method = self.model_attributes.configuration.get(
        ...
        vec_frst_harvested_wood_domestic *= (
            self.model_attributes.get_variable_unit_conversion_factor(
                self.modvar_frst_init_per_hh_wood_demand,
                self.model_ippu.modvar_ippu_demand_for_harvested_wood,
                "mass",
        ...
        if check_ippu is not None:
            ...
            # production data
            arr_production, dfs_ippu_harvested_wood = (
                self.model_ippu.get_production_with_recycling_adjustment(
                    df_afolu_trajectories,
                    vec_rates_gdp,
                )
            )
            ...
            while (i < len(dfs_ippu_harvested_wood)) and keep_going:
                ...
                if set(list_ippu_vars).issubset(df.columns):
                    arr_frst_harvested_wood_industrial = (
                        self.model_attributes.extract_model_variable(
                            df,
                            self.model_ippu.modvar_ippu_demand_for_harvested_wood,
                            expand_to_all_cats=True,
                    ...
                    vec_frst_harvested_wood_industrial_paper = (
                        arr_frst_harvested_wood_industrial[:, ind_paper]
                    )
                    vec_frst_harvested_wood_industrial_wood = (
                        arr_frst_harvested_wood_industrial[:, ind_wood]
                    )
                    keep_going = False
        ...
        if check_scoe is not None:
            ...
            vec_frst_harvested_wood_domestic = (
                vec_frst_harvested_wood_domestic[0]
                * vec_scoe_biomass_fuel_demand_growth_rate
            )
        ...
        vec_frst_c_wood = (
            vec_frst_harvested_wood_industrial_wood + vec_frst_harvested_wood_domestic
        ) * vec_frst_ef_c
        ...
        for i in range(len(vec_frst_c_from_hwp_paper) - 1):
            ...
            current_stock_paper = (
                vec_frst_c_from_hwp_paper[0]
                if (i == 0)
                else vec_frst_c_from_hwp_paper[i]
            )
            exp_k_paper = np.exp(-vec_frst_k_hwp_paper[i])
            vec_frst_c_from_hwp_paper[i + 1] = (
                current_stock_paper * exp_k_paper
                + ((1 - exp_k_paper) / vec_frst_k_hwp_paper[i]) * vec_frst_c_paper[i]
            )

            # wood
            current_stock_wood = (
                vec_frst_c_from_hwp_wood[0] if (i == 0) else vec_frst_c_from_hwp_wood[i]
            )
            exp_k_wood = np.exp(-vec_frst_k_hwp_wood[i])
            vec_frst_c_from_hwp_wood[i + 1] = (
                current_stock_wood * exp_k_wood
                + ((1 - exp_k_wood) / vec_frst_k_hwp_wood[i]) * vec_frst_c_wood[i]
            )

        # reduce from look back
        if n_years_lookback > 0:
            vec_frst_c_from_hwp_paper = vec_frst_c_from_hwp_paper[
                (n_years_lookback - 1) :
            ]
            vec_frst_c_from_hwp_wood = vec_frst_c_from_hwp_wood[
                (n_years_lookback - 1) :
            ]

        vec_frst_c_from_hwp_paper_delta = (
            vec_frst_c_from_hwp_paper[1:] - vec_frst_c_from_hwp_paper[0:-1]
        )
        vec_frst_c_from_hwp_wood_delta = (
            vec_frst_c_from_hwp_wood[1:] - vec_frst_c_from_hwp_wood[0:-1]
        )

        # get emissions from co2
        vec_frst_emissions_co2_hwp = (
            vec_frst_c_from_hwp_paper_delta + vec_frst_c_from_hwp_wood_delta
        )
    ...
    def qadj_get_inputs(
        ...
        x_proj_unadj = (
            x_proj_unadj if isinstance(x_proj_unadj, np.ndarray) else np.dot(x_0, Q)
        )
    ...
    def qadj_normalize_vector_for_adjustment(
        self,
        vec: np.ndarray,
        area: float,
    ...
    def reassign_pops_from_proj_to_carry(
        self,
        ...
        if arr_lu_derived.shape != arr_dem_based.shape:
            raise ValueError(
                f"Error in reassign_pops_from_proj_to_carry: array dimensions do not match: arr_lu_derived = {arr_lu_derived.shape}, arr_dem_based = {arr_dem_based.shape}."
            )
    ...
    def project(
        ...
        df_afolu_trajectories, df_se_internal_shared_variables = (
            self.model_socioeconomic.project(df_afolu_trajectories)
        )
        ...
        dict_check_integrated_variables = (
            self.model_attributes.check_integrated_df_vars(
                df_afolu_trajectories,
                self.dict_integration_variables_by_subsector,
                "all",
            )
        ...
        arr_agrc_exports_adj = sf.vec_bounds(
            arr_agrc_exports_unadj
            - sf.vec_bounds(arr_agrc_net_import_increase, (-np.inf, 0)),
            (np.zeros(arr_agrc_yield.shape), arr_agrc_yield),
        )
        arr_agrc_imports_adj = sf.vec_bounds(
            arr_agrc_imports_unadj
            + sf.vec_bounds(arr_agrc_net_import_increase, (0, np.inf)),
            (0, np.inf),
        )
        ...
        arr_lvst_exports_adj = sf.vec_bounds(
            arr_lvst_exports_unadj
            - sf.vec_bounds(arr_lvst_net_import_increase, (-np.inf, 0)),
            (np.zeros(arr_lvst_pop.shape), arr_lvst_pop),
        )
        arr_lvst_imports_adj = sf.vec_bounds(
            arr_lvst_imports_unadj
            + sf.vec_bounds(arr_lvst_net_import_increase, (0, np.inf)),
            (0, np.inf),
        )
        ...
        arrs_lndu_conv_to = np.array(
            [np.sum(x - np.diag(np.diagonal(x)), axis=0) for x in arrs_lndu_land_conv]
        )
        arrs_lndu_conv_from = np.array(
            [np.sum(x - np.diag(np.diagonal(x)), axis=1) for x in arrs_lndu_land_conv]
        )
        ...
        vec_agrc_frac_production_loss_to_landfills = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_agrc_frac_production_loss_to_msw,
                return_type="array_base",
        ...
        for modvar_lndu_frac_drywet in dict_arrs_lndu_frac_drywet.keys():
            cat_soil = clean_schema(
                self.model_attributes.get_variable_attribute(
                    modvar_lndu_frac_drywet, pycat_soil
                )
            )
            ind_soil = attr_soil.get_key_value_index(cat_soil)
            arr_lndu_ef4_n_volatilisation += (
                dict_arrs_lndu_frac_drywet[modvar_lndu_frac_drywet].transpose()
        ...
        arr_frst_biomass_consumed_temperate = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_frst_biomass_consumed_fire_temperate,
                expand_to_all_cats=True,
        ...
        arr_frst_biomass_consumed_tropical = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_frst_biomass_consumed_fire_tropical,
                expand_to_all_cats=True,
        ...
        for modvar in self.modvar_list_frst_frac_temptrop:
            # soil category
            cat_soil = clean_schema(
                self.model_attributes.get_variable_attribute(modvar, pycat_soil)
            )
            ind_soil = attr_soil.get_key_value_index(cat_soil)
            ...
            arr_frst_area_temptrop_burned_cur = (
                arr_area_frst
                * dict_arrs_frst_frac_temptrop[modvar]
                * arr_frst_frac_burned
            )
            arr_frst_total_dry_mass_burned_cur = (
                arr_frst_area_temptrop_burned_cur
                * dict_frst_modvar_to_array_forest_fires[modvar]
            )
            arr_frst_emissions_co2_fires += (
                arr_frst_total_dry_mass_burned_cur * arr_frst_ef_co2_fires
            )
        ...
        arr_agrc_frac_cropland_area = self.check_cropland_fractions(
            df_agrc_frac_cropland, "calculated"
        )
        arr_agrc_crop_area = (
            arr_agrc_frac_cropland_area.transpose() * vec_cropland_area.transpose()
        ).transpose()
        ...
        arr_lvst_nitrogen *= (
            arr_lvst_total_animal_mass
            * self.model_attributes.configuration.get("days_per_year")
        )
        ...
        arr_lsmm_frac_lost_volatilisation = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_lsmm_frac_loss_volatilisation,
                expand_to_all_cats=True,
        ...
        arr_lsmm_frac_used_for_fertilizer = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_lsmm_frac_n_available_used,
                expand_to_all_cats=True,
        ...
        cats_lsmm_manure_retrieval = self.model_attributes.get_variable_categories(
            self.modvar_lsmm_frac_n_available_used
        )
        ...
        for var_lvst_mm_frac in self.modvar_list_lvst_mm_fractions:
            ...
            arr_lsmm_emissions_ch4_cur = (
                arr_lvst_b0 * arr_lvst_volatile_solids * arr_lsmm_fracs_by_lvst
            )
            arr_lsmm_emissions_ch4_cur = (
                arr_lsmm_emissions_ch4_cur.transpose() * vec_lsmm_mcf_cur
            ).transpose()

            # get biogas recovery
            arr_lsmm_biogas_recovered_cur = (
                arr_lsmm_emissions_ch4_cur.transpose()
                * arr_lsmm_rf_biogas[:, index_cat_lsmm]
            ).transpose()
            arr_lsmm_emissions_ch4_cur -= arr_lsmm_biogas_recovered_cur
            arr_lsmm_biogas_recovered[:, index_cat_lsmm] = np.sum(
                arr_lsmm_biogas_recovered_cur, axis=1
            )

            # adjust
            arr_lsmm_emissions_ch4_cur *= self.model_attributes.get_scalar(
                self.modvar_lvst_animal_weight, "mass"
            )
            arr_lsmm_emission_ch4[:, index_cat_lsmm] = np.sum(
                arr_lsmm_emissions_ch4_cur, axis=1
            )
            ...
            vec_lsmm_n_from_codigestates = arr_lsmm_n_from_codigestates[
                :, index_cat_lsmm
            ]
            # get nitrogen from bedding per animal
            vec_lsmm_n_from_bedding *= np.sum(
                arr_lvst_pop * arr_lsmm_fracs_by_lvst, axis=1
            )

            # get totals lost to different pathways
            vec_lsmm_frac_lost_direct = sf.vec_bounds(
                (1 + vec_lsmm_ratio_n2_to_n2o)
                * arr_lsmm_ef_direct_n2o[:, index_cat_lsmm],
                (0, 1),
            )
            vec_lsmm_frac_lost_leaching = arr_lsmm_frac_lost_leaching[:, index_cat_lsmm]
            vec_lsmm_frac_lost_volatilisation = arr_lsmm_frac_lost_volatilisation[
                :, index_cat_lsmm
            ]
            ...
            vec_lsmm_frac_loss_ms = (
                vec_lsmm_frac_lost_leaching
                + vec_lsmm_frac_lost_volatilisation
                + vec_lsmm_frac_lost_direct
            )
            vec_lsmm_n_lost = (
                vec_lsmm_nitrogen_treated_cur
                * (1 + vec_lsmm_n_from_codigestates)
                * self.factor_n2on_to_n2o
            )

            # 10.25 FOR DIRECT EMISSIONS
            arr_lsmm_emission_n2o[:, index_cat_lsmm] = (
                vec_lsmm_n_lost * arr_lsmm_ef_direct_n2o[:, index_cat_lsmm]
            )
            # 10.28 FOR LOSSES DUE TO VOLATILISATION
            arr_lsmm_emission_n2o[:, index_cat_lsmm] += (
                vec_lsmm_n_lost * vec_soil_ef_ef4 * vec_lsmm_frac_lost_volatilisation
            )
            # 10.29 FOR LOSSES DUE TO LEACHING
            arr_lsmm_emission_n2o[:, index_cat_lsmm] += (
                vec_lsmm_n_lost * vec_soil_ef_ef5 * vec_lsmm_frac_lost_leaching
            )
            ...
            ) * (1 - vec_lsmm_frac_loss_ms) + vec_lsmm_n_from_bedding
            ...
            if cat_lsmm in cats_lsmm_manure_retrieval:
                if cat_lsmm == self.cat_lsmm_incineration:
                    ...
                    vec_lsmm_volatile_solids_incinerated = np.sum(
                        arr_lvst_volatile_solids * arr_lsmm_fracs_by_lvst, axis=1
                    )
                    vec_lsmm_volatile_solids_incinerated *= (
                        self.model_attributes.get_variable_unit_conversion_factor(
                            self.modvar_lvst_animal_weight,
                    ...
                    vec_lsmm_nitrogen_to_pasture += vec_lsmm_nitrogen_available * (
                        1 - vec_lsmm_frac_n_in_dung
                    )
                    # get incinerated N in dung - not used yet
                    vec_lsmm_nitrogen_to_incinerator = (
                        vec_lsmm_nitrogen_available * vec_lsmm_frac_n_in_dung
                    )
                    vec_lsmm_nitrogen_to_incinerator *= (
                        self.model_attributes.get_variable_unit_conversion_factor(
                            self.modvar_lvst_animal_weight,
                    ...
                    vec_lsmm_nitrogen_cur = (
                        vec_lsmm_nitrogen_available
                        * arr_lsmm_frac_used_for_fertilizer[:, index_cat_lsmm]
                    )
                    vec_lsmm_nitrogen_to_other += (
                        vec_lsmm_nitrogen_available - vec_lsmm_nitrogen_cur
                    )
                    # add to total by animal and splits by dung/urea (used in Soil Management subsector)
                    arr_lsmm_nitrogen_available[:, index_cat_lsmm] += (
                        vec_lsmm_nitrogen_cur
                    )
                    vec_lsmm_nitrogen_to_fertilizer_dung += (
                        vec_lsmm_nitrogen_cur * vec_lsmm_frac_n_in_dung
                    )
                    vec_lsmm_nitrogen_to_fertilizer_urine += vec_lsmm_nitrogen_cur * (
                        1 - vec_lsmm_frac_n_in_dung
                    )
        ...
        # n2o emissions
        arr_lsmm_emission_n2o *= self.model_attributes.get_scalar(
            self.modvar_lsmm_emissions_n2o, "gas"
        )
        arr_lsmm_emission_n2o *= self.model_attributes.get_scalar(
            self.modvar_lvst_animal_weight, "mass"
        )
        ...
        vec_soil_init_n_fertilizer_total = (
            vec_soil_init_n_fertilizer_synthetic + vec_soil_n_fertilizer_use_organic
        )
        ...
        vec_soil_area_fertilized = np.sum(
            arr_lndu_frac_fertilized * arr_land_use, axis=1
        )
        vec_soil_n_fertilizer_use_total = np.concatenate(
            [
                np.ones(1),
                np.cumprod(
                    vec_soil_area_fertilized[1:] / vec_soil_area_fertilized[0:-1]
                ),
            ]
        )
        ...
        vec_soil_n_fertilizer_use_synthetic = (
            vec_soil_n_fertilizer_use_total - vec_soil_n_fertilizer_use_organic
        )
        vec_soil_n_fertilizer_use_organic_to_pasture = sf.vec_bounds(
            vec_soil_n_fertilizer_use_synthetic, (0, np.inf)
        )
        vec_soil_n_fertilizer_use_organic_to_pasture -= (
            vec_soil_n_fertilizer_use_synthetic
        )
        vec_soil_n_fertilizer_use_synthetic = sf.vec_bounds(
            vec_soil_n_fertilizer_use_synthetic, (0, np.inf)
        )
        ...
        arr_soil_ef_c_organic_cultivated_soils = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_soil_ef_c_organic_soils,
                expand_to_all_cats=True,
        ...
        vec_soil_area_crop_pasture = arr_land_use[
            :, [self.ind_lndu_crop, self.ind_lndu_pstr]
        ].sum(axis=1)
        ...
        for modvar in self.modvar_list_agrc_frac_drywet:
            ...
            # get current factors
            arr_agrc_cur_wetdry_fertilized_crop = (
                dict_arrs_agrc_frac_drywet[modvar] * arr_agrc_crop_area
            )
            arr_agrc_cur_wetdry_fertilized_crop = (
                arr_agrc_cur_wetdry_fertilized_crop.transpose()
                * arr_lndu_frac_fertilized[:, self.ind_lndu_crop]
            )

            # get fraction of fertilized land represented by current area of cropland
            arr_soil_frac_cur_drywet_crop = (
                arr_agrc_cur_wetdry_fertilized_crop / vec_soil_area_fertilized
            )
            arr_soil_frac_cur_drywet_crop_organic = (
                arr_soil_frac_cur_drywet_crop * vec_soil_n_fertilizer_use_organic
            )
            arr_soil_frac_cur_drywet_crop_synthetic = (
                arr_soil_frac_cur_drywet_crop * vec_soil_n_fertilizer_use_synthetic
            )

            # update the dictionary for use later
            dict_soil_fertilizer_application_by_climate_organic.update(
                {cat_soil: np.sum(arr_soil_frac_cur_drywet_crop_organic, axis=0)}
            )
            dict_soil_fertilizer_application_by_climate_synthetic.update(
                {cat_soil: np.sum(arr_soil_frac_cur_drywet_crop_synthetic, axis=0)}
            )

            # get rice components
            vec_soil_n2odirectn_fon_rice += (
                arr_soil_frac_cur_drywet_crop_organic[ind_rice, :] * vec_soil_ef1_rice
            )
            vec_soil_n2odirectn_fsn_rice += (
                arr_soil_frac_cur_drywet_crop_synthetic[ind_rice, :] * vec_soil_ef1_rice
            )
            ...
            vec_soil_n2odirectn_fon += (
                np.sum(arr_soil_frac_cur_drywet_crop_organic, axis=0)
                * arr_soil_ef1_organic[:, ind_soil]
            )
            vec_soil_n2odirectn_fsn += (
                np.sum(arr_soil_frac_cur_drywet_crop_synthetic, axis=0)
                * arr_soil_ef1_synthetic[:, ind_soil]
            )
        ...
        for modvar in self.modvar_list_lndu_frac_drywet:
            ...
            # get current factors
            vec_soil_cur_wetdry_fertilized_pstr = (
                dict_arrs_lndu_frac_drywet[modvar] * arr_land_use
            )
            vec_soil_cur_wetdry_fertilized_pstr = (
                vec_soil_cur_wetdry_fertilized_pstr * arr_lndu_frac_fertilized
            )[:, self.ind_lndu_pstr]

            # get fraction of fertilized land represented by current area of cropland
            vec_soil_frac_cur_drywet_pstr = (
                vec_soil_cur_wetdry_fertilized_pstr / vec_soil_area_fertilized
            )
            vec_soil_n2odirectn_fon += (
                vec_soil_frac_cur_drywet_pstr * vec_soil_n_fertilizer_use_organic
            ) * arr_soil_ef1_organic[:, ind_soil]
            vec_soil_n2odirectn_fsn += (
                vec_soil_frac_cur_drywet_pstr * vec_soil_n_fertilizer_use_synthetic
            ) * arr_soil_ef1_synthetic[:, ind_soil]
            ...
            v_cur = dict_soil_fertilizer_application_by_climate_synthetic[
                cat_soil
            ].copy()
            dict_soil_fertilizer_application_by_climate_synthetic.update(
                {
        ...
        arr_agrc_crop_drymatter_per_unit = np.nan_to_num(
            arr_soil_yield / arr_soil_crop_area, nan=0.0, posinf=0.0
        )
        arr_agrc_crop_drymatter_per_unit = (
            arr_agrc_regression_m * arr_agrc_crop_drymatter_per_unit
            + arr_agrc_regression_b
        )
        arr_agrc_crop_drymatter_above_ground = (
            arr_agrc_crop_drymatter_per_unit * arr_soil_crop_area
        )
        ...
        vec_agrc_frac_residue_burned = dict_agrc_frac_residues_removed_burned.get(
            self.modvar_agrc_frac_residues_burned
        ).flatten()
        vec_agrc_frac_residue_removed = dict_agrc_frac_residues_removed_burned.get(
            self.modvar_agrc_frac_residues_removed
        ).flatten()
        ...
        vec_agrc_total_n_above_ground_residues_rice = (
            arr_agrc_total_n_above_ground_residues[ind_rice, :].copy()
        )
        arr_agrc_total_n_above_ground_residues[ind_rice, :] = 0
        vec_agrc_total_n_above_ground_residues_dry = np.sum(
            arr_agrc_total_n_above_ground_residues.transpose()
            * dict_arrs_agrc_frac_drywet[self.modvar_agrc_frac_dry],
            axis=1,
        )
        vec_agrc_total_n_above_ground_residues_wet = np.sum(
            arr_agrc_total_n_above_ground_residues.transpose()
            * dict_arrs_agrc_frac_drywet[self.modvar_agrc_frac_wet],
            axis=1,
        )

        # move to below ground and get total biomass (used for biomass burning)
        arr_agrc_ratio_bg_biomass_to_ag_biomass = (
            self.model_attributes.extract_model_variable(
                df_afolu_trajectories,
                self.modvar_agrc_ratio_below_ground_biomass_to_above_ground_biomass,
                expand_to_all_cats=True,
        ...
        arr_agrc_bg_biomass = (
            arr_agrc_crop_drymatter_per_unit * arr_soil_crop_area + arr_soil_yield
        ) * arr_agrc_ratio_bg_biomass_to_ag_biomass
        ...
        arr_agrc_total_n_below_ground_residues = (
            arr_agrc_bg_biomass * arr_agrc_n_content_bg_residues
        )
        vec_agrc_total_n_below_ground_residues_rice = (
            arr_agrc_total_n_below_ground_residues[:, ind_rice].copy()
        )
        ...
        scalar_soil_residue_to_fertilizer_equivalent = (
            self.model_attributes.get_variable_unit_conversion_factor(
                self.modvar_agrc_regression_m_above_ground_residue,
                self.modvar_lsmm_n_to_fertilizer_agg_dung,
                "mass",
        ...
        vec_agrc_total_n_residue_dry = (
            vec_agrc_total_n_above_ground_residues_dry
            + vec_agrc_total_n_below_ground_residues_dry
        ) * scalar_soil_residue_to_fertilizer_equivalent
        vec_agrc_total_n_residue_wet = (
            vec_agrc_total_n_above_ground_residues_wet
            + vec_agrc_total_n_below_ground_residues_wet
        ) * scalar_soil_residue_to_fertilizer_equivalent
        ...
        for modvar in self.modvar_list_agrc_frac_drywet:
            ...
            vec_soil_n2odirectn_fcr += (
                dict_agrc_modvar_to_n_residue[modvar]
                * arr_soil_ef1_organic[:, ind_soil]
            )
        ...
        vec_agrc_crop_residue_burned = (
            vec_agrc_crop_residue_biomass * vec_agrc_frac_residue_burned
        )
        ...
        cats_agrc_avg_combustion_factor = self.model_attributes.get_variable_categories(
            self.modvar_agrc_combustion_factor
        )
        inds_agrc_avg_combustion_factor = [
            attr_agrc.get_key_value_index(x) for x in cats_agrc_avg_combustion_factor
        ]
        vec_agrc_avg_combustion_factor = np.sum(
            vec_agrc_avg_combustion_factor
            * arr_agrc_crop_area[:, inds_agrc_avg_combustion_factor],
            axis=1,
        )
        vec_agrc_avg_combustion_factor /= np.sum(
            arr_agrc_crop_area[:, inds_agrc_avg_combustion_factor], axis=1
        )
        ...
        vec_agrc_emissions_ch4_biomass_burning = (
            vec_agrc_crop_residue_burned * vec_agrc_ef_ch4_biomass_burning
        )
        ...
        vec_agrc_emissions_n2o_biomass_burning = (
            vec_agrc_crop_residue_burned * vec_agrc_ef_n2o_biomass_burning
        )
        ...
        arr_lndu_factor_soil_management, arr_lndu_area_improved = (
            self.get_lndu_soil_soc_factors(
                df_afolu_trajectories,
                arr_land_use,
                arr_agrc_frac_cropland,
        ...
        arrs_lndu_soc_conversion_factors, vec_soil_ef1_soc_est = (
            self.get_mineral_soc_change_matrices(
                arr_agrc_crop_area,
                arr_land_use,
        ...
        vec_soil_delta_soc_mineral = (
            self.calculate_soc_stock_change_with_time_dependence(
                arrs_lndu_land_conv,
                arrs_lndu_soc_conversion_factors,
        ...
        for modvar in self.modvar_list_agrc_frac_temptrop:
            ...
            arr_soil_soc_crop_temptrop_cur = (
                arr_agrc_crop_area * dict_arrs_agrc_frac_temptrop[modvar]
            ).transpose()
            arr_soil_soc_crop_temptrop_cur *= arr_lndu_frac_organic_soils[
                :, self.ind_lndu_crop
            ]
            vec_soil_emission_co2_soil_carbon_organic += np.sum(
                arr_soil_soc_crop_temptrop_cur
                * arr_soil_ef_c_organic_cultivated_soils[:, ind_soil],
                axis=0,
            )
        ...
        vec_soil_n2odirectn_fsom = (
            -(
                sf.vec_bounds(vec_soil_delta_soc_mineral, (-np.inf, 0))
                / vec_soil_ratio_c_to_n_soil_organic_matter
            )
            * vec_soil_ef1_soc_est
        )
        vec_soil_emission_co2_soil_carbon_mineral = (
            -self.factor_c_to_co2 * vec_soil_delta_soc_mineral
        )
        vec_soil_emission_co2_soil_carbon_mineral *= self.model_attributes.get_scalar(
            self.modvar_lsmm_n_to_fertilizer_agg_dung, "mass"
        )
        vec_soil_emission_co2_soil_carbon_mineral *= self.model_attributes.get_gwp(
            "co2"
        )

        # get soil carbon from organic drained soils
        vec_soil_emission_co2_soil_carbon_organic *= (
            self.factor_c_to_co2 * self.model_attributes.get_gwp("co2")
        )
        ...
        vec_soil_emission_n2o_crop_residue = (
            vec_soil_n2odirectn_fcr + vec_soil_n2odirectn_fcr_rice
        )
        ...
        for modvar in self.modvar_list_agrc_frac_temptrop:
            ...
            ind_soil = attr_soil.get_key_value_index(cat_soil)
            vec_soil_crop_temptrop_cur = np.sum(
                arr_agrc_crop_area * dict_arrs_agrc_frac_temptrop[modvar], axis=1
            )
            vec_soil_crop_temptrop_cur *= (
                arr_lndu_frac_organic_soils[:, self.ind_lndu_crop]
                * arr_soil_ef2[:, ind_soil]
            )
        ...
        for modvar in self.modvar_list_lndu_frac_temptrop:
            ...
            ind_soil = attr_soil.get_key_value_index(cat_soil)
            vec_soil_pstr_temptrop_cur = (
                arr_land_use * dict_arrs_lndu_frac_temptrop[modvar]
            )[:, self.ind_lndu_pstr]
            vec_soil_pstr_temptrop_cur *= (
                arr_lndu_frac_organic_soils[:, self.ind_lndu_pstr]
                * arr_soil_ef2[:, ind_soil]
            )
        ...
        for modvar in self.modvar_list_frst_frac_temptrop:
            ...
            cats_lndu = [
                clean_schema(x)
                for x in self.model_attributes.get_ordered_category_attribute(
                    self.subsec_name_frst,
                    pycat_lndu,
                )
            ]
        ...
        for modvar in self.modvar_list_lndu_frac_drywet:
            ...
            vec_soil_frac_pstr_drywet_cur = (
                arr_land_use * dict_arrs_lndu_frac_drywet[modvar]
            )[:, self.ind_lndu_pstr] / arr_land_use[:, self.ind_lndu_pstr]
        ...
        for modvar in self.modvar_list_lndu_frac_drywet:
            ...
            vec_soil_fert_sn_cur_non_urea = (
                dict_soil_fertilizer_application_by_climate_synthetic[cat_soil].copy()
            )
            vec_soil_fert_sn_cur_urea = (
                vec_soil_fert_sn_cur_non_urea * vec_soil_frac_synthetic_fertilizer_urea
            )
            ...
            vec_soil_n2on_indirect_volatilisation_gasm_on += (
                vec_soil_component_gasm_on_cur
            )
            vec_soil_n2on_indirect_volatilisation_gasm_ppr += (
                vec_soil_component_gasm_ppr_cur
            )
        ...
        # update emissions
        vec_soil_emission_n2o_fertilizer += (
            vec_soil_n2on_indirect_volatilisation_gasf
            + vec_soil_n2on_indirect_volatilisation_gasm_on
        )
        ...
        # add up sources of N
        vec_soil_n2on_indirect_leaching_fert = (
            vec_soil_n_fertilizer_use_organic + vec_soil_n_fertilizer_use_synthetic
        )
        vec_soil_n2on_indirect_leaching_fert *= vec_soil_frac_leaching * vec_soil_ef5
        vec_soil_n2on_indirect_leaching_ppr = (
            vec_lsmm_nitrogen_to_pasture + vec_soil_n_fertilizer_use_organic_to_pasture
        )
        vec_soil_n2on_indirect_leaching_ppr *= vec_soil_frac_leaching * vec_soil_ef5

        vec_soil_n2on_indirect_leaching_cr = (
            vec_agrc_total_n_residue_dry
            + vec_agrc_total_n_residue_rice
            + vec_agrc_total_n_residue_wet
        )
        vec_soil_n2on_indirect_leaching_cr *= vec_soil_frac_leaching * vec_soil_ef5
        vec_soil_n2on_indirect_leaching_mineral_soils = (
            vec_soil_delta_soc_mineral / vec_soil_ratio_c_to_n_soil_organic_matter
        )
        vec_soil_n2on_indirect_leaching_mineral_soils *= (
            vec_soil_frac_leaching * vec_soil_ef5
        )

        # build aggregate emissions
        vec_soil_n2on_indirect_leaching = (
            vec_soil_n2on_indirect_leaching_fert
            + vec_soil_n2on_indirect_leaching_ppr
            + vec_soil_n2on_indirect_leaching_cr
            + vec_soil_n2on_indirect_leaching_mineral_soils
        ...
        vec_soil_lime_use_dolomite = (
            vec_soil_lime_init_dolomite[0] * vec_soil_lime_use_growth_rate
        )
        vec_soil_lime_use_limestone = (
            vec_soil_lime_init_limestone[0] * vec_soil_lime_use_growth_rate
        )
        ...
        vec_soil_lime_use_total = (
            vec_soil_lime_use_limestone + vec_soil_lime_use_dolomite
        )
        vec_soil_lime_use_total *= (
            self.model_attributes.get_variable_unit_conversion_factor(
                self.modvar_soil_qtyinit_liming_dolomite,
        ...
        vec_soil_emission_co2_urea_use = (
            vec_soil_ef_urea * vec_soil_n_fertilizer_use_synthetic_urea
        )
