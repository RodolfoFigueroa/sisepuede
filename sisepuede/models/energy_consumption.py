...
class EnergyConsumption:
    ...
    def get_neenergy_input_output_fields(
        self,
    ):
    ...
    def get_projection_subsectors(
        ...
        attr_subsec_table = attr_subsec.table[
            attr_subsec.table["subsector"].isin(self.valid_projection_subsecs)
        ]
        ...
        if subsectors_project is None:
            ...
            list_out = (
                [x for x in list_out if (x != self.subsec_name_fgtv)]
                if drop_fugitive_from_none_q
                else list_out
            )
        ...
        list_out = [
            dict_map.get(x)
            for x in valid_subsectors_project
            if (x in list_out) or (dict_map.get(x) in list_out)
        ]
    ...
    def _initialize_sector_vars_afolu(
        self,
    ) -> None:
    ...
    def _initialize_subsector_vars_ccsq(
        self,
    ) -> None:
        ...
        * self.modvar_dicts_ccsq_****
        ...
        self.modvar_ccsq_demand_per_co2 = (
            "CCSQ Energy Demand Per Mass of :math:\\text{CO}_2 Captured"
        )
        self.modvar_ccsq_efficiency_fact_heat_en_geothermal = (
            "CCSQ Efficiency Factor for Heat Energy from Geothermal"
        )
        self.modvar_ccsq_efficiency_fact_heat_en_hydrogen = (
            "CCSQ Efficiency Factor for Heat Energy from Hydrogen"
        )
        self.modvar_ccsq_efficiency_fact_heat_en_natural_gas = (
            "CCSQ Efficiency Factor for Heat Energy from Natural Gas"
        )
        self.modvar_ccsq_energy_consumption_electricity = (
            "Electrical Energy Consumption from CCSQ"
        )
        ...
        self.modvar_ccsq_emissions_n2o = (
            ":math:\\text{N}_2\\text{O} Emissions from CCSQ"
        )
        ...
        self.modvar_ccsq_frac_heat_en_geothermal = (
            "CCSQ Fraction Heat Energy Demand Geothermal"
        )
        self.modvar_ccsq_frac_heat_en_hydrogen = (
            "CCSQ Fraction Heat Energy Demand Hydrogen"
        )
        self.modvar_ccsq_frac_heat_en_natural_gas = (
            "CCSQ Fraction Heat Energy Demand Natural Gas"
        )
        self.modvar_ccsq_total_sequestration = (
            "Annual Capture and Sequestration by Type"
        )

        # get some dictionaries implied by the CCSQ attribute tables
        self.modvar_dicts_ccsq_fuel_vars = (
        ...
        self.modvar_dict_ccsq_fuel_fractions_to_efficiency_factors = (
            self.modvar_dicts_ccsq_fuel_vars.get(
    ...
    def _initialize_subsector_vars_fgtv(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_fgtv_****
        ...
        self.modvar_fgtv_ef_ch4_distribution = (
            ":math:\\text{CH}_4 FGTV Distribution Emission Factor"
        )
        self.modvar_fgtv_ef_ch4_production_flaring = (
            ":math:\\text{CH}_4 FGTV Production Flaring Emission Factor"
        )
        self.modvar_fgtv_ef_ch4_production_fugitive = (
            ":math:\\text{CH}_4 FGTV Production Fugitive Emission Factor"
        )
        self.modvar_fgtv_ef_ch4_production_venting = (
            ":math:\\text{CH}_4 FGTV Production Venting Emission Factor"
        )
        self.modvar_fgtv_ef_ch4_transmission = (
            ":math:\\text{CH}_4 FGTV Transmission Emission Factor"
        )
        self.modvar_fgtv_ef_co2_distribution = (
            ":math:\\text{CO}_2 FGTV Distribution Emission Factor"
        )
        self.modvar_fgtv_ef_co2_production_flaring = (
            ":math:\\text{CO}_2 FGTV Production Flaring Emission Factor"
        )
        self.modvar_fgtv_ef_co2_production_fugitive = (
            ":math:\\text{CO}_2 FGTV Production Fugitive Emission Factor"
        )
        self.modvar_fgtv_ef_co2_production_venting = (
            ":math:\\text{CO}_2 FGTV Production Venting Emission Factor"
        )
        self.modvar_fgtv_ef_co2_transmission = (
            ":math:\\text{CO}_2 FGTV Transmission Emission Factor"
        )
        self.modvar_fgtv_ef_n2o_production_flaring = (
            ":math:\\text{N}_2\\text{O} FGTV Production Flaring Emission Factor"
        )
        self.modvar_fgtv_ef_n2o_production_fugitive = (
            ":math:\\text{N}_2\\text{O} FGTV Production Fugitive Emission Factor"
        )
        self.modvar_fgtv_ef_n2o_production_venting = (
            ":math:\\text{N}_2\\text{O} FGTV Production Venting Emission Factor"
        )
        self.modvar_fgtv_ef_n2o_transmission = (
            ":math:\\text{N}_2\\text{O} FGTV Transmission Emission Factor"
        )
        self.modvar_fgtv_ef_nmvoc_distribution = (
            "NMVOC FGTV Distribution Emission Factor"
        )
        self.modvar_fgtv_ef_nmvoc_production_flaring = (
            "NMVOC FGTV Production Flaring Emission Factor"
        )
        self.modvar_fgtv_ef_nmvoc_production_fugitive = (
            "NMVOC FGTV Production Fugitive Emission Factor"
        )
        self.modvar_fgtv_ef_nmvoc_production_venting = (
            "NMVOC FGTV Production Venting Emission Factor"
        )
        self.modvar_fgtv_ef_nmvoc_transmission = (
        ...
        self.modvar_fgtv_frac_non_fugitive_flared = (
            "Fraction Non-Fugitive :math:\\text{CH}_4 Flared"
        )
        self.modvar_fgtv_frac_reduction_fugitive_leaks = "Reduction in Fugitive Leaks"

    def _initialize_subsector_vars_inen(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_dict_inen_****
        ...
        self.modvar_inen_emissions_ch4 = (
            ":math:\\text{CH}_4 Emissions from Industrial Energy"
        )
        self.modvar_inen_emissions_co2 = (
            ":math:\\text{CO}_2 Emissions from Industrial Energy"
        )
        ...
        self.modvar_inen_frac_en_geothermal = (
            "Industrial Energy Fuel Fraction Geothermal"
        )
        self.modvar_inen_frac_en_hgl = (
        ...
        self.modvars_inen_list_fuel_fraction = (
            self.model_attributes.get_vars_by_assigned_class_from_akaf(
                self.dict_inen_fuel_categories_to_fuel_variables,
                "fuel_fraction",
            )
        )
    ...
    def _initialize_subsector_vars_scoe(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_dicts_scoe_****
        ...
        self.modvar_scoe_efficiency_fact_heat_en_coal = (
            "SCOE Efficiency Factor for Heat Energy from Coal"
        )
        self.modvar_scoe_efficiency_fact_heat_en_diesel = (
            "SCOE Efficiency Factor for Heat Energy from Diesel"
        )
        self.modvar_scoe_efficiency_fact_heat_en_electricity = (
            "SCOE Efficiency Factor for Heat Energy from Electricity"
        )
        self.modvar_scoe_efficiency_fact_heat_en_gasoline = (
            "SCOE Efficiency Factor for Heat Energy from Gasoline"
        )
        self.modvar_scoe_efficiency_fact_heat_en_hgl = (
            "SCOE Efficiency Factor for Heat Energy from Hydrocarbon Gas Liquids"
        )
        self.modvar_scoe_efficiency_fact_heat_en_hydrogen = (
            "SCOE Efficiency Factor for Heat Energy from Hydrogen"
        )
        self.modvar_scoe_efficiency_fact_heat_en_kerosene = (
            "SCOE Efficiency Factor for Heat Energy from Kerosene"
        )
        self.modvar_scoe_efficiency_fact_heat_en_natural_gas = (
            "SCOE Efficiency Factor for Heat Energy from Natural Gas"
        )
        self.modvar_scoe_efficiency_fact_heat_en_solid_biomass = (
        ...
        self.modvar_scoe_emissions_n2o = (
            ":math:\\text{N}_2\\text{O} Emissions from SCOE"
        )
        ...
        self.modvar_dict_scoe_fuel_fractions_to_efficiency_factors = (
            self.modvar_dicts_scoe_fuel_vars.get(
                "fuel_fraction_variable_by_fuel_to_energy_efficiency_variable_by_fuel",
            )
        )

    def _initialize_subsector_vars_trde(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
    ...
    def _initialize_subsector_vars_trns(
        self,
    ) -> None:
        """Initialize model variables, categories, and indices associated with
        ...
        * self.modvar_dicts_trns_****
        ...
        self.modvar_trns_ef_combustion_mobile_biofuels_ch4 = (
            ":math:\\text{CH}_4 Biofuels Mobile Combustion Emission Factor"
        )
        self.modvar_trns_ef_combustion_mobile_diesel_ch4 = (
            ":math:\\text{CH}_4 Diesel Mobile Combustion Emission Factor"
        )
        self.modvar_trns_ef_combustion_mobile_gasoline_ch4 = (
            ":math:\\text{CH}_4 Gasoline Mobile Combustion Emission Factor"
        )
        self.modvar_trns_ef_combustion_mobile_hgl_ch4 = ":math:\\text{CH}_4 Hydrocarbon Gas Liquids Mobile Combustion Emission Factor"
        self.modvar_trns_ef_combustion_mobile_kerosene_ch4 = (
            ":math:\\text{CH}_4 Kerosene Mobile Combustion Emission Factor"
        )
        self.modvar_trns_ef_combustion_mobile_natural_gas_ch4 = (
            ":math:\\text{CH}_4 Natural Gas Mobile Combustion Emission Factor"
        )
        self.modvar_trns_ef_combustion_mobile_biofuels_n2o = (
            ":math:\\text{N}_2\\text{O} Biofuels Mobile Combustion Emission Factor"
        )
        self.modvar_trns_ef_combustion_mobile_diesel_n2o = (
            ":math:\\text{N}_2\\text{O} Diesel Mobile Combustion Emission Factor"
        )
        self.modvar_trns_ef_combustion_mobile_gasoline_n2o = (
            ":math:\\text{N}_2\\text{O} Gasoline Mobile Combustion Emission Factor"
        )
        ...
        self.modvar_trns_ef_combustion_mobile_kerosene_n2o = (
            ":math:\\text{N}_2\\text{O} Kerosene Mobile Combustion Emission Factor"
        )
        self.modvar_trns_ef_combustion_mobile_natural_gas_n2o = (
            ":math:\\text{N}_2\\text{O} Natural Gas Mobile Combustion Emission Factor"
        )
        self.modvar_trns_electrical_efficiency = "Electrical Vehicle Efficiency"
        self.modvar_trns_emissions_ch4 = (
            ":math:\\text{CH}_4 Emissions from Transportation"
        )
        self.modvar_trns_emissions_co2 = (
            ":math:\\text{CO}_2 Emissions from Transportation"
        )
        self.modvar_trns_emissions_n2o = (
            ":math:\\text{N}_2\\text{O} Emissions from Transportation"
        )
        ...
        self.modvar_trns_fuel_fraction_biofuels = (
            "Transportation Mode Fuel Fraction Biofuels"
        )
        self.modvar_trns_fuel_fraction_diesel = (
            "Transportation Mode Fuel Fraction Diesel"
        )
        self.modvar_trns_fuel_fraction_electricity = (
            "Transportation Mode Fuel Fraction Electricity"
        )
        self.modvar_trns_fuel_fraction_gasoline = (
            "Transportation Mode Fuel Fraction Gasoline"
        )
        self.modvar_trns_fuel_fraction_hgl = (
            "Transportation Mode Fuel Fraction Hydrocarbon Gas Liquids"
        )
        self.modvar_trns_fuel_fraction_hydrogen = (
            "Transportation Mode Fuel Fraction Hydrogen"
        )
        self.modvar_trns_fuel_fraction_kerosene = (
            "Transportation Mode Fuel Fraction Kerosene"
        )
        self.modvar_trns_fuel_fraction_natural_gas = (
        ...
        self.modvar_trns_modeshare_public_private = (
        ...
        self.modvar_trns_vehicle_distance_traveled_biofuels = (
            "Vehicle Distance Traveled from Biofuels"
        )
        self.modvar_trns_vehicle_distance_traveled_diesel = (
            "Vehicle Distance Traveled from Diesel"
        )
        self.modvar_trns_vehicle_distance_traveled_electricity = (
            "Vehicle Distance Traveled from Electricity"
        )
        self.modvar_trns_vehicle_distance_traveled_gasoline = (
            "Vehicle Distance Traveled from Gasoline"
        )
        self.modvar_trns_vehicle_distance_traveled_hgl = (
            "Vehicle Distance Traveled from Hydrocarbon Gas Liquids"
        )
        self.modvar_trns_vehicle_distance_traveled_hydrogen = (
            "Vehicle Distance Traveled from Hydrogen"
        )
        self.modvar_trns_vehicle_distance_traveled_kerosene = (
            "Vehicle Distance Traveled from Kerosene"
        )
        self.modvar_trns_vehicle_distance_traveled_natural_gas = (
        ...
        self.modvars_trns_list_fuel_efficiency = (
            self.model_attributes.get_vars_by_assigned_class_from_akaf(
                self.dict_trns_fuel_categories_to_fuel_variables,
                "fuel_efficiency",
            )
    ...
    def get_agrc_lvst_prod_and_intensity(
        self,
        df_neenergy_trajectories: pd.DataFrame,
    ) -> Tuple:
        ...
        modvar_inen_agrc_prod, arr_inen_agrc_prod = (
        ...
        modvar_inen_lvst_prod, arr_inen_lvst_prod = (
            self.model_attributes.get_optional_or_integrated_standard_variable(
                df_neenergy_trajectories,
                self.modvar_lvst_total_animal_mass,
                None,
        ...
        arr_inen_init_energy_consumption_agrc = (
    ...
    def get_enfu_fuel_costs_per_energy(
        self,
        df_neenergy_trajectories: pd.DataFrame,
    ...
    def get_enfu_fuel_costs_per_energy_general(
        self,
        df_neenergy_trajectories: pd.DataFrame,
        type_conversion: str,
    ...
    def get_enfu_fuel_costs_per_energy_thermal(
        self,
        df_neenergy_trajectories: pd.DataFrame,
        modvar_price: Union[str, None] = None,
        units_energy: Union[str, None] = None,
        ...
        """
        modvar_price = (
            self.modvar_enfu_price_thermal if (modvar_price is None) else modvar_price
        )
    ...
    def get_fgtv_array_for_fugitive_emissions(
        self,
        df_neenergy_trajectories: pd.DataFrame,
        modvar_cur: str,
        ...
        arr_ef_per_config_energy = arr_ef_mass_per_volume / (
            array_energy_density * scalar_volume
        )  # tonne/m3 / (mj/litre*(litre/m3)) -> (tonne/m3)/(mj/m3) => tonne/mj
    ...
    def get_fgtv_demands_and_trade(
        self,
        df_neenergy_trajectories: pd.DataFrame,
    ) -> Tuple[pd.DataFrame]:
    ...
    def get_inen_dict_fuel_categories_to_fuel_variables(
        self,
    ) -> Dict:
    ...
    def get_trns_dict_fuel_categories_to_fuel_variables(
        self,
    ) -> dict:
    ...
    def project_energy_consumption_by_fuel_from_effvars(
        self,
        df_neenergy_trajectories: pd.DataFrame,
        ...
        for modvar_fuel_frac in dict_fuel_fracs:
        ...
        if (arr_elastic_driver is not None) and (arr_elasticity is not None):
            ...
            arr_demand = sf.do_array_mult(
                arr_demand[0] * arr_growth_demand,
                arr_activity,
            )
        ...
        for modvar_fuel_frac in dict_fuel_fracs:
            ...
            arr_consumption_fuel = np.nan_to_num(
                arr_demand * arr_frac / arr_efficiency,
                nan=0.0,
                posinf=0.0,
            )
    ...
    def project_energy_consumption_by_fuel_from_fuel_cats(
        self,
        df_neenergy_trajectories: pd.DataFrame,
        ...
        return_none |= (
            self.model_attributes.get_variable(modvar_fuel_efficiency) is None
        )

        if return_none:
            self._log(
                "Error in project_energy_consumption_by_fuel_from_fuel_cats(): invalid model variable specification.",
                type_log="error",
            )
        ...
        for modvar_fuel_frac in dict_fuel_fracs:
            ...
            arr_frac = dict_fuel_fracs.get(modvar_fuel_frac)
            arr_frac_norm += np.nan_to_num(
                arr_frac.transpose() / vec_efficiency,
                nan=0.0,
                posinf=0.0,
            )
        ...
        arr_demand = np.nan_to_num(
            vec_consumption_intensity_initial / arr_frac_norm[0],
            nan=0.0,
            posinf=0.0,
        )
    ...
    def project_enfu_production_and_demands(
        self,
        df_neenergy_trajectories: pd.DataFrame,
        ...
        output_energy_units = (
            target_energy_units
            if (
                self.model_attributes.get_energy_equivalent(target_energy_units)
                is not None
            )
        ...
        for modvar in modvars_energy_demands:
            ...
            arr_demands += arr_tmp
            arr_demands_distribution += (
                arr_tmp if (modvar in modvars_energy_distribution_demands) else 0.0
            )
    ...
    def project_ccsq(
        ...
        arr_ccsq_energy_intensity_sequestration = (
            self.model_attributes.extract_model_variable(
                df_neenergy_trajectories,
                self.modvar_ccsq_demand_per_co2,
                expand_to_all_cats=True,
        ...
        arr_ccsq_demand_energy, dict_ccsq_demands_by_fuel_heat = (
            self.project_energy_consumption_by_fuel_from_effvars(
                df_neenergy_trajectories,
                self.modvar_ccsq_total_sequestration,
                None,
                None,
        ...
        for k in fuels_loop:
            dict_ccsq_demands_by_fuel_heat[k] = (
                dict_ccsq_demands_by_fuel_heat[k]
                * arr_ccsq_energy_intensity_sequestration
                * arr_ccsq_frac_energy_heat
            )
        ...
        arr_ccsq_demand_electricity *= (
            arr_ccsq_frac_energy_elec * arr_ccsq_energy_intensity_sequestration
        )
        ...
        for var_ener_frac in list(
            ...
            arr_ccsq_demand_by_fuel[:, index_cat_fuel] = (
                np.sum(arr_ccsq_endem_cur_fuel, axis=1) * scalar_ccsq_to_enfu_var_units
            )

            # get emissions
            arr_ccsq_emissions_ch4 += (
                arr_ccsq_endem_cur_fuel.transpose()
                * arr_ccsq_ef_by_fuel_ch4[:, index_cat_fuel]
            )
            arr_ccsq_emissions_co2 += (
                arr_ccsq_endem_cur_fuel.transpose()
                * arr_ccsq_ef_by_fuel_co2[:, index_cat_fuel]
            )
            arr_ccsq_emissions_n2o += (
                arr_ccsq_endem_cur_fuel.transpose()
                * arr_ccsq_ef_by_fuel_n2o[:, index_cat_fuel]
            )
        ...
        arr_ccsq_demand_by_fuel[:, index_cat_fuel] = (
            np.sum(arr_ccsq_demand_electricity, axis=1) * scalar_ccsq_to_enfu_var_units
        )
    ...
    def project_fugitive_emissions(
        ...
        for modvar_emission in dict_emission_to_fugitive_components:
            ...
            arr_ef_production_flaring = self.get_fgtv_array_for_fugitive_emissions(
                df_neenergy_trajectories,
                dict_emission_to_fugitive_components[modvar_emission][
                    "production_flaring"
                ],
                arr_enfu_energy_density_volumetric,
            )
            ...
            arr_fgtv_emit_distribution = (
                sf.do_array_mult(
                    arr_demands_distribution * arr_ef_distribution,
                    1 - vec_fgtv_reduction_leaks,
                )
    ...
    def project_industrial_energy(
        ...
        dict_inen_fuel_frac_to_eff_cat = (
            self.dict_inen_fuel_categories_to_fuel_variables.copy()
        )
        ...
        arr_inen_energy_consumption_intensity_prod = (
            arr_inen_prod_energy_intensity
            * self.model_attributes.get_variable_unit_conversion_factor(
                self.model_ippu.modvar_ippu_qty_total_production,
                self.modvar_inen_en_prod_intensity_factor,
                "mass",
        ...
        arr_inen_energy_consumption_intensity_prod[:, index_inen_agrc] += (
            vec_inen_energy_intensity_agrc_lvst
        )

        # project future consumption
        arr_inen_demand_energy_prod, dict_inen_energy_consumption_prod = (
            self.project_energy_consumption_by_fuel_from_fuel_cats(
                df_neenergy_trajectories,
        ...
        arr_inen_energy_consumption_intensity_gdp = (
            self.model_attributes.extract_model_variable(
                df_neenergy_trajectories,
                self.modvar_inen_en_gdp_intensity_factor,
                expand_to_all_cats=True,
        ...
        arr_inen_demand_energy_gdp, dict_inen_energy_consumption_gdp = (
            self.project_energy_consumption_by_fuel_from_fuel_cats(
                df_neenergy_trajectories,
        ...
        for k in dict_inen_energy_consumption_prod.keys():
            dict_inen_energy_consumption[k] = (
                dict_inen_energy_consumption_gdp[k]
                + dict_inen_energy_consumption_prod[k]
            )
        ...
        for var_ener_frac in self.modvars_inen_list_fuel_fraction:
            ...
            arr_inen_emissions_ch4 += (
                arr_inen_endem_cur_fuel.transpose()
                * arr_inen_ef_by_fuel_ch4[:, index_cat_fuel]
            )
            arr_inen_emissions_co2 += (
                arr_inen_endem_cur_fuel.transpose()
                * arr_inen_ef_by_fuel_co2[:, index_cat_fuel]
            )
            arr_inen_emissions_n2o += (
                arr_inen_endem_cur_fuel.transpose()
                * arr_inen_ef_by_fuel_n2o[:, index_cat_fuel]
            )

            # update the demand for fuel in the output array
            arr_inen_demand_by_fuel[:, index_cat_fuel] = np.sum(
                arr_inen_endem_cur_fuel,
                axis=1,
            )

            # add electricity demand and total energy demand
            arr_inen_demand_electricity += (
                arr_inen_endem_cur_fuel
                if (cat_fuel == self.cat_enfu_electricity)
                else 0.0
            )
            arr_inen_demand_electricity_total += (
                arr_inen_endem_cur_fuel.sum(axis=1)
                if (cat_fuel == self.cat_enfu_electricity)
                else 0.0
            )
        ...
        array_inen_emission_frac_captured = (
            self.model_attributes.extract_model_variable(
                df_neenergy_trajectories,
        ...
        array_inen_emissions_co2_captured = (
            arr_inen_emissions_co2 * array_inen_emission_frac_captured
        )
        ...
        df_out += [
            ...
            # FUEL VALUE
            self.model_attributes.array_to_df(
                arr_inen_total_fuel_value
                * arr_inen_demand_by_fuel
                * scalar_inen_to_enfu_var_units,
                self.modvar_enfu_value_of_fuel_inen,
                reduce_from_all_cats_to_specified_cats=True,
            ),
            ...
            self.model_attributes.array_to_df(
                (arr_inen_demand_energy_prod + arr_inen_demand_energy_gdp)
                * scalar_energy,
    ...
    def project_scoe(
        ...
        arr_scoe_enerdem_elasticity_mmmgdp_elec = (
            self.model_attributes.extract_model_variable(
                df_neenergy_trajectories,
                self.modvar_scoe_elasticity_mmmgdp_energy_demand_elec_to_gdppc,
                expand_to_all_cats=True,
        ...
        # get demand scalars
        arr_scoe_demscalar_elec_energy_demand = (
            self.model_attributes.extract_model_variable(
                df_neenergy_trajectories,
                self.modvar_scoe_demscalar_elec_energy_demand,
                all_cats_missing_val=1.0,
        ...
        arr_scoe_demscalar_heat_energy_demand = (
            self.model_attributes.extract_model_variable(
                df_neenergy_trajectories,
        ...
        arr_scoe_demand_heat_energy_hh, dict_scoe_demands_by_fuel_heat_hh = (
            self.project_energy_consumption_by_fuel_from_effvars(
                df_neenergy_trajectories,
                self.modvar_scoe_consumpinit_energy_per_hh_heat,
                vec_hh,
        ...
        arr_scoe_demand_heat_energy_mmgdp, dict_scoe_demands_by_fuel_heat_mmmgdp = (
            self.project_energy_consumption_by_fuel_from_effvars(
                df_neenergy_trajectories,
                self.modvar_scoe_consumpinit_energy_per_mmmgdp_heat,
                vec_gdp,
        ...
        for k in list(
            ...
            arr_tmp_demands_total = (
                ...
                + dict_scoe_demands_by_fuel_heat_mmmgdp[k]
            )
        ...
        for var_ener_frac in list(
            ...
            arr_scoe_demand_by_fuel[:, index_cat_fuel] = (
                np.sum(arr_scoe_endem_cur_fuel, axis=1) * scalar_scoe_to_enfu_var_units
            )

            # apply emission factors
            arr_scoe_emissions_ch4 += (
                arr_scoe_endem_cur_fuel.transpose()
                * arr_scoe_ef_by_fuel_ch4[:, index_cat_fuel]
            )
            arr_scoe_emissions_co2 += (
                arr_scoe_endem_cur_fuel.transpose()
                * arr_scoe_ef_by_fuel_co2[:, index_cat_fuel]
            )
            arr_scoe_emissions_n2o += (
                arr_scoe_endem_cur_fuel.transpose()
                * arr_scoe_ef_by_fuel_n2o[:, index_cat_fuel]
            )

            # add electricity demand and total energy demand
            if cat_fuel == self.cat_enfu_electricity:
                arr_scoe_demand_by_fuel[:, index_cat_fuel] += (
                    np.sum(arr_scoe_demand_electricity, axis=1)
                    * scalar_scoe_to_enfu_var_units
                )
    ...
    def project_transportation(
        ...
        scalar_tnrs_length_demfrieght_to_dempass = (
            self.model_attributes.get_variable_unit_conversion_factor(
                self.modvar_trde_demand_mtkm,
                self.modvar_trde_demand_pkm,
                "length",
        ...
        for category in dict_trde_cats_to_trns_vars.keys():
            ...
            if category == self.cat_trde_frgt:
                ...
                array_trde_vehicle_dem_cur_by_cat *= (
                    scalar_tnrs_length_demfrieght_to_dempass
                )
        ...
        df_out += [
            ...
            self.model_attributes.array_to_df(
                array_trns_total_mass_distance_demand
                * scalar_trns_total_mass_distance_demand,
                self.modvar_trns_mass_distance_traveled,
                reduce_from_all_cats_to_specified_cats=True,
            ),
        ...
        scalar_trns_ved_to_enfu_var_units = (
            self.model_attributes.get_variable_unit_conversion_factor(
                self.modvar_enfu_energy_density_volumetric,
                self.modvar_enfu_energy_demand_by_fuel_trns,
                "energy",
        ...
        for cat_fuel in fuels_loop:
            ...
            scalar_trns_fuel_efficiency_to_demand = (
                self.model_attributes.get_variable_unit_conversion_factor(
            ...
            modvar_trns_vmt_by_fuel_cut = (
                self.dict_trns_fuel_categories_to_fuel_variables.get(cat_fuel)
            )
            modvar_trns_vmt_by_fuel_cut = (
            ...
            if arr_trns_fuel_efficiency_cur is not None:
                ...
                arr_trns_energydem_cur_fuel = (
                    arr_trns_fueldem_cur_fuel.transpose()
                    * vec_trns_volumetric_enerdensity_by_fuel
                ).transpose()
                arr_trns_energydem_cur_fuel *= (
                    self.model_attributes.get_variable_unit_conversion_factor(
                        modvar_trns_fuel_efficiency_cur,
                ...
                arr_trns_fuel_energydem_cur_fuel_ch4 = (
                    arr_trns_energydem_cur_fuel * scalar_fuel_energy_to_ef_ch4
                )
                arr_emissions_ch4_cur_fuel = (
                    arr_trns_ef_ch4_cur * arr_trns_fuel_energydem_cur_fuel_ch4
                )
                ...
                arr_trns_fuel_energydem_cur_fuel_co2 = (
                    arr_trns_energydem_cur_fuel * scalar_fuel_energy_to_ef_co2
                )
                arr_emissions_co2_cur_fuel = (
                    arr_trns_fuel_energydem_cur_fuel_co2.transpose()
                    * vec_trns_ef_by_fuel_co2_cur
                ).transpose()
                ...
                arr_trns_fuel_energydem_cur_fuel_n2o = (
                    arr_trns_energydem_cur_fuel * scalar_fuel_energy_to_ef_n2o
                )
                arr_emissions_n2o_cur_fuel = (
                    arr_trns_ef_n2o_cur * arr_trns_fuel_energydem_cur_fuel_n2o
                )
                ...
                scalar_electric_eff_to_distance_equiv = (
                    self.model_attributes.get_variable_unit_conversion_factor(
    ...
    def project_transportation_demand(
        self,
        df_neenergy_trajectories: pd.DataFrame,
        vec_pop: np.ndarray,
        vec_rates_gdp: np.ndarray,
        ...
        array_trde_freight_dem_by_cat = (
            array_trde_dem_init_freight[0] * array_trde_growth_freight_dem_by_cat
        )
        ...
        array_trde_growth_passenger_dem_by_cat = (
            sf.project_growth_scalar_from_elasticity(
                vec_rates_gdp_per_capita,
                array_trde_elast_passenger_demand_to_gdppc,
                elasticity_type="standard",
                rates_are_factors=False,
        ...
        array_trde_passenger_dem_by_cat = (
            array_trde_dem_init_passenger[0] * array_trde_growth_passenger_dem_by_cat
        )
        array_trde_passenger_dem_by_cat = (
            array_trde_passenger_dem_by_cat.transpose() * vec_pop
        ).transpose()
    ...
    def project(
        ...
        df_neenergy_trajectories, df_se_internal_shared_variables = (
            self.model_socioeconomic.project(df_neenergy_trajectories)
        )
