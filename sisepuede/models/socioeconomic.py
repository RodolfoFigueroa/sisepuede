...
class Socioeconomic:
    ...
    def _initialize_subsector_vars_econ(
        self,
    ) -> None:
    ...
    def _initialize_subsector_vars_gnrl(
        self,
    ) -> None:
        ...
        * self.modvar_gnrl_*
        ...
        self.modvar_gnrl_climate_change_hydropower_availability = (
        ...
        self.modvar_gnrl_emission_limit_n2o = (
            ":math:\\text{N}_2\\text{O} Annual Emission Limit"
        )
