...
class Grid:
    ...
    def get_boundaries_from_centroids_delta(
        self,
        ...
        # set grid boundaries
        adj = -delta if (self.get_orientation(centroids) == "increasing") else delta
    ...
    def get_orientation(
        ...
        out = "increasing" if (centroids[0] == centroids.min()) else "decreasing"
...
class GriddedDataset:
    ...
    def _initialize_datasets(
        ...
        dict_datasets = dict(
            ...
            if (isinstance(v, rx.raster_array.xarray.DataArray) & isinstance(k, str))
        )
