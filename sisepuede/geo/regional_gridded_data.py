...
class RegionalGriddedData:
    ...
    def _initialize_grid_indexing_array(
        self,
    ...
    def get_transition_data_frame(
        ...
        array_0 = (
            self.get_regional_array(array_0) if isinstance(array_0, str) else array_0
        )

        array_1 = (
            self.get_regional_array(array_1) if isinstance(array_1, str) else array_1
        )

        array_areas = self.get_cell_areas() if array_areas is None else array_areas
