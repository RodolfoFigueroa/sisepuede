...
class Units:
    ...
    def _initialize_attribute_table(
        self,
        attributes: Union[AttributeTable, str],
        key_prependage: Union[str, None] = None,
    ) -> None:
    ...
    def build_conversion_target_field(
        self,
        unit_target: str,
    ) -> Union[str, None]:
    ...
    def get_unit_key(
        ...
        flags_missing = (
            [flags_missing] if not sf.islistlike(flags_missing) else list(flags_missing)
        )
...
class UnitsManager:
    ...
    def _initialize_attribute_tables(
        ...
        attribute_directory = (
            sf.check_path(attributes, False) if isinstance(attributes, str) else None
        )
